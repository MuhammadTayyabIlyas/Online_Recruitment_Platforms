            ...
            <div class="flex flex-col gap-4">
                <div class="flex items-center gap-3">
                    ...
                    <div class="flex items-center gap-2 text-sm text-gray-500">
                        ...
                        <a href="<?php echo e(route('jobs.index')); ?>" class="px-3 py-1 rounded-full border border-transparent bg-gray-100 text-gray-700 hover:bg-gray-200 transition">Jobs</a>
                        <a href="<?php echo e(route('study-programs.index')); ?>" class="px-3 py-1 rounded-full border border-blue-200 bg-blue-50 text-blue-700 font-semibold">Study Programs</a>
                    </div>
                </div>
                <div>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->hasRole('educational_institution')): ?>
                <div class="mb-6 bg-blue-50 border border-blue-200 rounded-lg p-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                    ...
                    <div class="flex items-center gap-2">
                        <a href="<?php echo e(route('institution.programs.create')); ?>" class="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 text-sm font-semibold">Add Program</a>
                        <a href="<?php echo e(route('institution.programs.index')); ?>" class="px-4 py-2 bg-white border border-blue-200 text-blue-700 rounded-md hover:bg-blue-50 text-sm">My Programs</a>
                    </div>
                </div>
        ...
        <?php else: ?>
            <div class="mb-6 bg-white border border-gray-200 rounded-lg p-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                ...
                <a href="<?php echo e(route('register')); ?>" class="px-4 py-2 bg-blue-600 text-white rounded-md hover:bg-blue-700 text-sm font-semibold">Register as Institution</a>
            </div>
        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="w-full lg:w-1/4 space-y-6">
                <form wire:submit.prevent="applyFilters" class="bg-white p-6 rounded-lg shadow-sm border border-gray-200 sticky top-24 space-y-4">
                    ...
                    <div>
                        ...
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['selectedCountry'];
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <div>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['minFee'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        ...
                        <div>
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__errorArgs = ['maxFee'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="w-full lg:w-3/4">
                <div class="mb-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                    <p class="text-sm text-gray-500">Showing <span class="font-medium text-gray-900"><?php echo e($programs->total()); ?></span> programs</p>
                    <div class="flex items-center gap-3">
                ...
                <div class="space-y-4">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $programs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $program): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 hover:shadow-md transition-shadow <?php echo e($program->is_featured ? 'ring-2 ring-yellow-400 bg-gradient-to-r from-yellow-50 to-white' : ''); ?>">
                            <div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                                <div class="flex items-start gap-4 flex-1">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($program->university->logo): ?>
                                        <div class="flex-shrink-0">
                                            <img src="<?php echo e(Storage::url($program->university->logo)); ?>" alt="<?php echo e($program->university->name); ?>" class="w-16 h-16 object-contain rounded-lg border border-gray-200">
                                        </div>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <div class="flex-1">
                                        <div class="flex items-center gap-2 mb-1 flex-wrap">
                                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-blue-100 text-blue-800">
                                                <?php echo e($program->degree->name); ?>

                                            </span>
                                            <span class="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-gray-700">
                                                <?php echo e($program->subject->name); ?>
                                        ...
                                        <h3 class="text-xl font-bold text-gray-900">
                                            <a href="<?php echo e(route('study-programs.show', [Str::slug($program->country->name), $program->slug])); ?>" class="hover:text-blue-600 transition-colors">
                                                <?php echo e($program->title); ?>

                                            </a>
                                        </h3>
                                        <p class="text-gray-600 font-medium"><?php echo e($program->university->name); ?></p>
                                        <div class="flex items-center text-sm text-gray-500 mt-2 gap-4 flex-wrap">
                                            ...
                                            <span class="flex items-center gap-1">
                                                ...
                                                <?php echo e($program->language); ?>

                                            </span>
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($program->study_mode): ?>
                                                <span class="flex items-center gap-1">
                                            ...
                                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($program->intake): ?>
                                                <span class="flex items-center gap-1">
                                                    ...
                                                    Intake: <?php echo e($program->intake); ?>
...
<?php /**PATH /var/www/placemenet/resources/views/livewire/study-program-search.blade.php ENDPATH**/ ?>