...
<div class="container mx-auto px-4 py-8">
    <div class="mb-6">
        <div class="flex items-center justify-between">
            ...
            <a href="<?php echo e(route('content-creator.blogs.create')); ?>" class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-medium rounded-lg shadow-lg transition transform hover:scale-105">
        ...
        <div class="bg-gradient-to-br from-gray-500 to-gray-600 rounded-lg shadow-lg p-6 text-white">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold mt-2"><?php echo e($draftBlogs); ?></p>
                </div>
                <div class="bg-white bg-opacity-20 rounded-full p-3">
                    <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="bg-gradient-to-br from-yellow-500 to-yellow-600 rounded-lg shadow-lg p-6 text-white">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold mt-2"><?php echo e($pendingBlogs); ?></p>
                </div>
                <div class="bg-white bg-opacity-20 rounded-full p-3">
                    <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="bg-gradient-to-br from-green-500 to-green-600 rounded-lg shadow-lg p-6 text-white">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold mt-2"><?php echo e($approvedBlogs); ?></p>
                </div>
                <div class="bg-white bg-opacity-20 rounded-full p-3">
                    <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="bg-gradient-to-br from-red-500 to-red-600 rounded-lg shadow-lg p-6 text-white">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold mt-2"><?php echo e($rejectedBlogs); ?></p>
                </div>
                <div class="bg-white bg-opacity-20 rounded-full p-3">
                    <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-4 mb-6">
        <form action="<?php echo e(route('content-creator.blogs.index')); ?>" method="GET" class="flex flex-wrap gap-4 items-end">
            ...
            <div class="flex gap-2">
                ...
                <a href="<?php echo e(route('content-creator.blogs.index')); ?>"
                        ...
                        <tr class="hover:bg-gray-50 transition">
                            <td class="px-6 py-4">
                                <div class="flex items-center">
                                    ...
                                    <?php else: ?>
                                        <div class="w-20 h-12 bg-gray-200 rounded-lg mr-4 flex items-center justify-center">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                ...
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($blog->status->value === 'rejected' && $blog->admin_feedback): ?>
                                    <div class="mt-1">
                                        <button type="button"
                                                onclick="alert('Admin Feedback:\n\n<?php echo e(addslashes($blog->admin_feedback)); ?>')"
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-gray-900">
                                    ...
                                    <?php elseif($blog->submitted_at): ?>
                                        <?php echo e($blog->submitted_at->format('M d, Y')); ?>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="text-sm text-gray-900"><?php echo e(number_format($blog->views_count)); ?></span>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex items-center justify-end space-x-2">
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($blog->canBeSubmitted()): ?>
                                        <form action="<?php echo e(route('content-creator.blogs.submit', $blog)); ?>"
                                              method="POST"
                                              class="inline"
                                              onsubmit="return confirm('Submit this blog for admin review?');">
                                            <?php echo csrf_field(); ?>
                                            <button type="submit"
                                    ...
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($blog->status->canBeWithdrawn()): ?>
                                        <form action="<?php echo e(route('content-creator.blogs.withdraw', $blog)); ?>"
                                              method="POST"
                                              class="inline"
                                              onsubmit="return confirm('Withdraw this blog from review?');">
                                            <?php echo csrf_field(); ?>
                                            <button type="submit"
                    ...
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                        <tr>
                            <td colspan="6" class="px-6 py-12 text-center">
                                ...
                                <div class="mt-6">
                                    <a href="<?php echo e(route('content-creator.blogs.create')); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/placemenet/resources/views/content-creator/blogs/index.blade.php ENDPATH**/ ?>