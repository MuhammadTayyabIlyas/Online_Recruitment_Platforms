<?php $__env->startSection('title', $job->title ?? 'Job Details'); ?>
            ...
            <div class="bg-white shadow rounded-lg overflow-hidden">
                ...
                <div class="p-6 border-b border-gray-200">
                    <div class="flex items-start justify-between">
                        <div class="flex items-center gap-4">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($job->company && $job->company->logo): ?>
                                <img src="<?php echo e($job->company->logo_url); ?>" alt="<?php echo e($job->company->name); ?>"
                            ...
                            <div>
                                <h1 class="text-2xl font-bold text-gray-900"><?php echo e($job->title); ?></h1>
                                <p class="text-lg text-gray-600"><?php echo e($job->company->company_name ?? 'Company'); ?></p>
                            </div>
                        </div>
                    ...
                    <div class="flex flex-wrap gap-4 mt-4">
                        ...
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$job->hide_salary && ($job->min_salary || $job->max_salary)): ?>
                            <span class="inline-flex items-center text-gray-600">
                                <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="lg:w-1/3">
            ...
            <div class="bg-white shadow rounded-lg p-6 mb-6">
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->user()->hasRole('job_seeker')): ?>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($job->expires_at && $job->expires_at->isPast()): ?>
                            <div class="text-center">
                                <p class="text-red-600 font-medium">This job is no longer accepting applications.</p>
                            </div>
                        <?php else: ?>
                            <a href="<?php echo e(route('jobseeker.applications.create', $job)); ?>"
                               class="block w-full text-center px-4 py-3 bg-indigo-600 text-white rounded-md hover:bg-indigo-700 font-medium">
                                Apply Now
                            </a>
                            <form action="<?php echo e(route('jobseeker.saved.store', $job)); ?>" method="POST" class="mt-3">
                                <?php echo csrf_field(); ?>
                                <button type="submit"
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($job->expires_at): ?>
                    <p class="text-center text-sm text-gray-500 mt-4">
                        Application deadline: <?php echo e($job->expires_at->format('M d, Y')); ?>
            ...
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($job->company): ?>
                <div class="bg-white shadow rounded-lg p-6">
                    ...
                    <div class="flex items-center gap-4 mb-4">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($job->company->logo): ?>
                            <img src="<?php echo e($job->company->logo_url); ?>" alt="<?php echo e($job->company->name); ?>"
                        ...
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        <div>
                            <h4 class="font-medium text-gray-900"><?php echo e($job->company->company_name); ?></h4>
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($job->company->industry): ?>
                                <p class="text-sm text-gray-500"><?php echo e($job->company->industry->name); ?></p>
                            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                    </div>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($job->company->description): ?>
                        <p class="text-gray-600 text-sm"><?php echo e(Str::limit($job->company->description, 200)); ?></p>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
            <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        </div>
...
<?php echo json_encode($jobSchema, JSON_UNESCAPED_SLASHES|JSON_UNESCAPED_UNICODE|JSON_PRETTY_PRINT); ?>

</script>
<?php $__env->stopPush(); ?>

<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/placemenet/resources/views/jobs/show.blade.php ENDPATH**/ ?>