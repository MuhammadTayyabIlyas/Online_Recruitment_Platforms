<?php $__env->startSection('title', __('Welcome to PlaceMeNet - Find Your Dream Job')); ?>
...
<div class="fixed left-4 top-1/2 -translate-y-1/2 z-50 drop-shadow-lg space-y-3" aria-live="polite">
    ...
    <div id="cookie-message" class="max-w-[240px] bg-white/95 border border-gray-200 rounded-xl px-4 py-3 text-xs text-gray-700 shadow-xl opacity-0 translate-y-2 transition-all duration-500 ease-out relative pr-10 pointer-events-auto">
        <button type="button" id="cookie-close" aria-label="<?php echo e(__('Close cookie message')); ?>" class="absolute top-2 right-2 text-gray-400 hover:text-gray-600">
            &times;
        </button>
        <?php echo e(__('By using this website, you agree to our Cookies Policy.')); ?>

        <a href="<?php echo e(route('privacy')); ?>#cookies-policy" class="underline text-blue-600 font-semibold"><?php echo e(__('View Policy')); ?></a>
    </div>
</div>
...
<section id="hero" class="relative bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 min-h-[600px] flex items-center overflow-hidden">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 w-full">
        ...
        <div class="text-center mb-10 md:mb-12">
            ...
            <h1 class="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-4 md:mb-6 leading-tight animate-fade-in-up">
                <?php echo e(__('Find Your')); ?> <span class="text-yellow-300 inline-block hover:scale-110 transition-transform duration-300 cursor-default"><?php echo e(__('Dream Job')); ?></span> <?php echo e(__('Today')); ?>

            </h1>

            
            <p class="text-lg sm:text-xl md:text-2xl text-blue-100 max-w-3xl mx-auto mb-2 animate-fade-in-up animation-delay-200">
                <?php echo e(__('Connect with thousands of top employers and discover')); ?>

                <span class="text-white font-semibold">50,000+</span> <?php echo e(__('opportunities')); ?>

            </p>

            
            <p class="text-blue-200 text-sm md:text-base animate-fade-in-up animation-delay-400">
                <?php echo e(__('Your next career move starts here')); ?>
    ...
    .animation-delay-400 {
            ...
            <form action="<?php echo e(route('jobs.index')); ?>" method="GET"
                ...
                <div class="flex flex-col md:flex-row gap-3 md:gap-4">
                    ...
                    <div class="flex-1 relative">
                        ...
                        <input
                            type="text"
                            name="q"
                            placeholder="<?php echo e(__('Job title, keywords, or company')); ?>"
                    ...
                    <div class="md:w-64 relative">
                        <div class="relative">
                            ...
                            <input
                                type="text"
                                name="location"
                                placeholder="<?php echo e(__('City, state, or remote')); ?>"
                                class="w-full pl-12 pr-4 py-3 md:py-4 border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none text-gray-700 placeholder-gray-400 text-base md:text-lg"
                                data-geo-city
                            >
                        </div>
                    ...
                    >
                        ...
                        <span><?php echo e(__('Search Jobs')); ?></span>
                    </button>
                </div>
                ...
                <div class="mt-4 pt-4 border-t border-gray-100 hidden md:block">
                    <p class="text-sm text-gray-500 inline">
                        <span class="font-medium"><?php echo e(__('Popular:')); ?></span>
                    </p>
                    <div class="inline-flex flex-wrap gap-2 ml-2">
                        <a href="<?php echo e(route('jobs.index', ['q' => 'software engineer'])); ?>"
                           class="text-sm text-blue-600 hover:text-blue-800 hover:underline">
                            <?php echo e(__('Software Engineer')); ?>

                        </a>
                        <span class="text-gray-300">•</span>
                        <a href="<?php echo e(route('jobs.index', ['q' => 'marketing'])); ?>"
                           class="text-sm text-blue-600 hover:text-blue-800 hover:underline">
                            <?php echo e(__('Marketing')); ?>

                        </a>
                        <span class="text-gray-300">•</span>
                        <a href="<?php echo e(route('jobs.index', ['q' => 'remote'])); ?>"
                           class="text-sm text-blue-600 hover:text-blue-800 hover:underline">
                            <?php echo e(__('Remote Jobs')); ?>

                        </a>
                        <span class="text-gray-300">•</span>
                        <a href="<?php echo e(route('jobs.index', ['q' => 'data analyst'])); ?>"
                           class="text-sm text-blue-600 hover:text-blue-800 hover:underline">
                            <?php echo e(__('Data Analyst')); ?>
        ...
        <div class="flex flex-col sm:flex-row flex-wrap justify-center gap-3 sm:gap-4 mb-10 md:mb-12 px-4">
            ...
            <a href="<?php echo e(route('visa.index')); ?>"
               class="group inline-flex items-center justify-center gap-2 border-2 border-white/30 text-white hover:bg-white hover:text-blue-700 px-6 py-3 rounded-lg font-medium transition-all duration-300 hover-lift">
                <svg class="h-5 w-5 group-hover:scale-110 transition-transform duration-300" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div class="flex flex-wrap justify-center gap-6 md:gap-12 text-white/90">
            ...
            <div class="group flex items-center gap-2 cursor-default hover:scale-110 transition-transform duration-300">
                ...
                <div>
                    <p class="text-xl md:text-2xl font-bold group-hover:text-yellow-300 transition-colors duration-300"><?php echo e(number_format($statsJobs)); ?></p>
                    <p class="text-xs md:text-sm text-blue-200"><?php echo e(__('Active Jobs')); ?></p>
                </div>
            </div>
            ...
            <div class="group flex items-center gap-2 cursor-default hover:scale-110 transition-transform duration-300">
                ...
                <div>
                    <p class="text-xl md:text-2xl font-bold group-hover:text-yellow-300 transition-colors duration-300"><?php echo e(number_format($statsCompanies)); ?></p>
                    <p class="text-xs md:text-sm text-blue-200"><?php echo e(__('Companies')); ?></p>
                </div>
            </div>
            ...
            <div class="group flex items-center gap-2 cursor-default hover:scale-110 transition-transform duration-300">
                ...
                <div>
                    <p class="text-xl md:text-2xl font-bold group-hover:text-yellow-300 transition-colors duration-300"><?php echo e(number_format($statsSeekers)); ?></p>
                    <p class="text-xs md:text-sm text-blue-200"><?php echo e(__('Job Seekers')); ?></p>
                </div>
            </div>
            ...
            <div class="group flex items-center gap-2 cursor-default hover:scale-110 transition-transform duration-300">
                ...
                <div>
                    <p class="text-xl md:text-2xl font-bold group-hover:text-yellow-300 transition-colors duration-300"><?php echo e($approvalRate); ?>%</p>
                    <p class="text-xs md:text-sm text-blue-200"><?php echo e(__('Approved Applications')); ?></p>
                </div>
            </div>
        </div>
...
<section id="how-it-works" class="py-16 bg-gradient-to-br from-blue-600 to-indigo-700 relative overflow-hidden">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div class="text-center mb-12">
            <h2 class="text-3xl md:text-4xl font-bold text-white mb-3"><?php echo e(__('How It Works')); ?></h2>
            <p class="text-lg text-blue-100 max-w-2xl mx-auto"><?php echo e(__('Your journey to the perfect job in three simple steps')); ?></p>
        </div>
        ...
        <div class="relative max-w-5xl mx-auto">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
                <div class="how-step">
                    ...
                    <h3><?php echo e(__('Create Your Profile')); ?></h3>
                    <p><?php echo e(__('Sign up and build your professional profile with skills and experience')); ?></p>
                </div>
                ...
                <div class="how-step">
                    ...
                    <h3><?php echo e(__('Search & Apply')); ?></h3>
                    <p><?php echo e(__('Browse thousands of jobs and apply with one click')); ?></p>
                </div>
                ...
                <div class="how-step">
                    ...
                    <h3><?php echo e(__('Get Hired')); ?></h3>
                    <p><?php echo e(__('Connect with employers and land your dream job')); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="mt-12 bg-white rounded-2xl p-8 md:p-10 text-center shadow-2xl relative overflow-hidden">
            ...
            <h3 class="text-2xl md:text-3xl font-bold text-gray-900 mb-3 relative"><?php echo e(__('Ready to Start Your Career Journey?')); ?></h3>
            <p class="text-lg text-gray-600 mb-6 max-w-2xl mx-auto relative"><?php echo e(__('Join thousands of job seekers who found their dream jobs')); ?></p>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div class="p-6 rounded-2xl bg-gradient-to-br from-blue-50 to-indigo-50 border border-blue-100 shadow-sm flex flex-col gap-3">
                ...
                <a href="<?php echo e(route('jobs.index')); ?>" class="inline-flex items-center gap-2 text-blue-700 font-semibold hover:text-blue-900">
                    Browse jobs
            ...
            <div class="p-6 rounded-2xl bg-gradient-to-br from-indigo-50 to-purple-50 border border-indigo-100 shadow-sm flex flex-col gap-3">
                ...
                <a href="<?php echo e(route('study-programs.index')); ?>" class="inline-flex items-center gap-2 text-indigo-700 font-semibold hover:text-indigo-900">
                    Explore programs
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6"/>
                    </svg>
            ...
            <div class="p-6 rounded-2xl bg-gradient-to-br from-blue-50 to-teal-50 border border-teal-100 shadow-sm flex flex-col gap-3">
                ...
                <a href="<?php echo e(route('visa.index')); ?>" class="inline-flex items-center gap-2 text-teal-700 font-semibold hover:text-teal-900">
                    See pathways
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6"/>
                    </svg>
        ...
        <div class="mt-10 text-center">
            <a href="<?php echo e(route('contact')); ?>" class="inline-flex items-center justify-center gap-2 px-6 py-3 rounded-lg bg-blue-600 text-white font-semibold hover:bg-blue-700 transition">
                Talk to a human
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7l5 5m0 0l-5 5m5-5H6"/>
                </svg>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid md:grid-cols-3 gap-6 items-center text-white">
            ...
            <div class="flex flex-col sm:flex-row md:flex-col gap-3 justify-center md:justify-end">
                <a href="<?php echo e(route('login')); ?>" class="inline-flex items-center justify-center gap-2 bg-white text-blue-700 font-semibold px-6 py-3 rounded-lg hover:bg-blue-50 transition">
                    Post a job
                </a>
                <a href="<?php echo e(route('contact')); ?>" class="inline-flex items-center justify-center gap-2 border border-white text-white font-semibold px-6 py-3 rounded-lg hover:bg-white/10 transition">
                    Talk to sales
                </a>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/placemenet/resources/views/home.blade.php ENDPATH**/ ?>