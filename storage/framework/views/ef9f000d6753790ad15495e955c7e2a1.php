<?php $__env->startSection('title', 'Edit Job Alert'); ?>
...
<div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <form action="<?php echo e(route('jobseeker.alerts.update', $alert)); ?>" method="POST" class="bg-white shadow rounded-lg p-6 space-y-6">
        <?php echo csrf_field(); ?>
        ...
        <div>
            ...
            <input type="text" name="name" id="name" value="<?php echo e(old('name', $alert->name)); ?>"
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <div>
            ...
            <input type="text" name="keywords" id="keywords" value="<?php echo e(old('keywords', $alert->keywords)); ?>"
                   class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <div>
            ...
            <input type="text" name="location" id="location" value="<?php echo e(old('location', $alert->location)); ?>"
                   class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500"
        ...
        <div>
            ...
            <select name="category_id" id="category_id"
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($category->id); ?>" <?php echo e(old('category_id', $alert->category_id) == $category->id ? 'selected' : ''); ?>>
        ...
        <div>
            ...
            <select name="job_type_id" id="job_type_id"
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $jobTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $jobType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($jobType->id); ?>" <?php echo e(old('job_type_id', $alert->job_type_id) == $jobType->id ? 'selected' : ''); ?>>
        ...
        <div>
            ...
            <select name="employment_type_id" id="employment_type_id"
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $employmentTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $employmentType): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <option value="<?php echo e($employmentType->id); ?>" <?php echo e(old('employment_type_id', $alert->employment_type_id) == $employmentType->id ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <div>
            ...
            <div class="mt-1 relative">
                ...
                <input type="number" name="min_salary" id="min_salary" value="<?php echo e(old('min_salary', $alert->min_salary)); ?>"
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <div>
            ...
            <select name="frequency" id="frequency"
                ...
                <option value="daily" <?php echo e(old('frequency', $alert->frequency) == 'daily' ? 'selected' : ''); ?>>Daily</option>
                <option value="weekly" <?php echo e(old('frequency', $alert->frequency) == 'weekly' ? 'selected' : ''); ?>>Weekly</option>
            </select>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <div class="flex items-center">
            <label class="inline-flex items-center">
                <input type="checkbox" name="is_active" value="1" <?php echo e(old('is_active', $alert->is_active) ? 'checked' : ''); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/placemenet/resources/views/jobseeker/job-alerts/edit.blade.php ENDPATH**/ ?>