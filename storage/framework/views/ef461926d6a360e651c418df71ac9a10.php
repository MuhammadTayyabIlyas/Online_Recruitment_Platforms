...
<div class="container mx-auto px-4 py-8">
    <div class="mb-6">
        <div class="flex items-center justify-between">
            ...
            <a href="<?php echo e(route('admin.blogs.show', $blog)); ?>" class="inline-flex items-center px-4 py-2 bg-gray-600 hover:bg-gray-700 text-white rounded-lg transition">
...
unset($__errorArgs, $__bag); ?>"
                                      placeholder="Brief summary of the blog post (max 500 characters)"><?php echo e(old('excerpt', $blog->excerpt)); ?></textarea>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            <label for="featured_image" class="block text-sm font-medium text-gray-700 mb-1">
                                <?php echo e($blog->featured_image ? 'Replace Featured Image' : 'Featured Image'); ?>
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <span class="text-sm font-medium text-gray-900"><?php echo e($blog->author->name); ?></span>
                        </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="number"
                                   name="featured_order"
                                   id="featured_order"
                                   value="<?php echo e(old('featured_order', $blog->featured_order ?? 0)); ?>"
                                   min="0"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/placemenet/resources/views/admin/blogs/edit.blade.php ENDPATH**/ ?>