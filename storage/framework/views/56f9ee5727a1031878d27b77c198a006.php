...
<?php $__env->startSection('page-title', 'Program Details'); ?>
...
<div class="max-w-6xl mx-auto space-y-6">
    ...
    <!-- Back Button -->
    <div>
        <a href="<?php echo e(route('admin.programs.index')); ?>" class="inline-flex items-center text-sm font-medium text-gray-600 hover:text-gray-900">
        ...
        <div class="p-6 border-b border-gray-100">
            <div class="flex items-start justify-between">
                <div>
                    ...
                    <p class="text-sm text-gray-600 mt-1">Created <?php echo e($program->created_at->diffForHumans()); ?> by <?php echo e($program->creator->name ?? 'N/A'); ?></p>
                </div>
                <a href="<?php echo e(route('admin.programs.edit', $program)); ?>" class="px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors font-medium">
                    Edit Program
                </a>
            </div>
        </div>
        ...
        <div class="p-6">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div>
                    ...
                    <p class="text-sm font-semibold text-gray-900"><?php echo e($program->country->name ?? 'N/A'); ?></p>
                </div>
                ...
                <div>
                    ...
                    <p class="text-sm font-semibold text-gray-900"><?php echo e($program->study_mode); ?></p>
                </div>

                <!-- Language -->
                <div>
                    <label class="block text-xs font-medium text-gray-500 uppercase tracking-wider mb-1">Language</label>
                    <p class="text-sm font-semibold text-gray-900"><?php echo e($program->language); ?></p>
                </div>
                ...
                <!-- Duration -->
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($program->duration): ?>
                <div>
                    <label class="block text-xs font-medium text-gray-500 uppercase tracking-wider mb-1">Duration</label>
                    <p class="text-sm font-semibold text-gray-900"><?php echo e($program->duration); ?></p>
                </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                <!-- Intake -->
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($program->intake): ?>
                <div>
                    <label class="block text-xs font-medium text-gray-500 uppercase tracking-wider mb-1">Next Intake</label>
                    <p class="text-sm font-semibold text-gray-900"><?php echo e($program->intake); ?></p>
                </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                <!-- Application Deadline -->
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($program->application_deadline): ?>
                <div>
                    <label class="block text-xs font-medium text-gray-500 uppercase tracking-wider mb-1">Application Deadline</label>
                    <p class="text-sm font-semibold text-gray-900"><?php echo e($program->application_deadline->format('M d, Y')); ?></p>
                </div>
                <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="md:col-span-2">
                    ...
                    <a href="<?php echo e($program->program_url); ?>" target="_blank" class="text-sm font-medium text-blue-600 hover:text-blue-800 break-all">
                        <?php echo e($program->program_url); ?>
        ...
        <div class="p-6 border-b border-gray-100">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-sm text-gray-600 mt-1"><?php echo e($program->applications->count()); ?> total applications</p>
                </div>
            </div>
        </div>

        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($program->applications->count() > 0): ?>
            <div class="overflow-x-auto">
                <table class="w-full">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $program->applications; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $application): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-gray-50 transition-colors">
                                <td class="px-6 py-4">
                                    <div class="flex items-center">
                                        ...
                                        <div class="ml-3">
                                            <p class="text-sm font-semibold text-gray-900"><?php echo e($application->user->name ?? 'N/A'); ?></p>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4">
                                ...
                                <td class="px-6 py-4">
                                    <form method="POST" action="<?php echo e(route('admin.programs.application.update-status', [$program, $application])); ?>" class="inline">
                                        <?php echo csrf_field(); ?>
                                        ...
                                        <select
                                            ...
                                            <?php echo e($application->status === 'pending' ? 'bg-yellow-100 text-yellow-800 focus:ring-yellow-500' : ''); ?>

                                            <?php echo e($application->status === 'under_review' ? 'bg-blue-100 text-blue-800 focus:ring-blue-500' : ''); ?>

                                            <?php echo e($application->status === 'accepted' ? 'bg-green-100 text-green-800 focus:ring-green-500' : ''); ?>

                                            <?php echo e($application->status === 'rejected' ? 'bg-red-100 text-red-800 focus:ring-red-500' : ''); ?>"
                                        >
                                ...
                                <td class="px-6 py-4">
                                    <p class="text-sm text-gray-600"><?php echo e($application->created_at->format('M d, Y')); ?></p>
                                    <p class="text-xs text-gray-500"><?php echo e($application->created_at->diffForHumans()); ?></p>
                                </td>
                                <td class="px-6 py-4">
                                    <a
                                        href="<?php echo e(route('admin.programs.application.show', [$program, $application])); ?>"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/placemenet/resources/views/admin/programs/show.blade.php ENDPATH**/ ?>