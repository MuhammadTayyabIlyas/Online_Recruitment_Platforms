<?php $__env->startSection('title', 'Study Abroad in Europe | PlaceMeNet'); ?>
<?php $__env->startSection('meta_description', 'Find and compare the best European universities, degrees, and tuition options. Get tailored picks, application support, and visa guidance to secure your spot faster.'); ?>
    ...
    <section id="search" class="bg-white">
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div class="flex flex-col md:flex-row md:items-end md:justify-between mb-6 gap-4">
                ...
                <a href="<?php echo e(route('contact')); ?>" class="inline-flex items-center gap-2 text-indigo-700 font-semibold hover:text-indigo-900">
...
[$__name, $__params] = $__split('study-program-search', []);

$key = null;

$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-959118190-0', null);
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/placemenet/resources/views/study-programs/index.blade.php ENDPATH**/ ?>