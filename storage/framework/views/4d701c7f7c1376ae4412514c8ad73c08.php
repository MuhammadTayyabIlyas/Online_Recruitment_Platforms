    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="flex flex-col lg:flex-row gap-8">
            ...
            <div class="w-full lg:w-1/4 space-y-6">
                <!-- Active Filters -->
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($category || $jobType || $employmentType || $experience || $isRemote || $minSalary): ?>
                <div class="bg-white rounded-xl shadow-sm p-5">
                    ...
                    <div class="flex flex-wrap gap-2">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($isRemote): ?>
                ...
                <div class="bg-white rounded-xl shadow-sm p-5">
                    ...
                    <div class="space-y-2">
                        <label class="flex items-center cursor-pointer hover:bg-gray-50 -mx-2 px-2 py-1 rounded" wire:click="selectJobType('')">
                            <input type="radio" name="jobType" value="" <?php echo e($jobType === '' ? 'checked' : ''); ?> class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300" readonly>
                            <span class="ml-2 text-sm <?php echo e(empty($jobType) ? 'text-gray-900 font-semibold' : 'text-gray-600'); ?>">All Types</span>
                        </label>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $jobTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <label class="flex items-center cursor-pointer hover:bg-gray-50 -mx-2 px-2 py-1 rounded" wire:click="selectJobType('<?php echo e($type->id); ?>')">
                            <input type="radio" name="jobType" value="<?php echo e($type->id); ?>" <?php echo e($jobType == $type->id ? 'checked' : ''); ?> class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300" readonly>
                            <span class="ml-2 text-sm text-gray-600"><?php echo e($type->name); ?></span>
                        </label>
                ...
                <div class="bg-white rounded-xl shadow-sm p-5">
                    ...
                    <div class="space-y-2 max-h-60 overflow-y-auto">
                        <label class="flex items-center cursor-pointer hover:bg-gray-50 -mx-2 px-2 py-1 rounded sticky top-0 bg-white z-10" wire:click="selectCategory('')">
                            <input type="radio" name="category" value="" <?php echo e($category === '' ? 'checked' : ''); ?> class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300" readonly>
                            <span class="ml-2 text-sm <?php echo e(empty($category) ? 'text-gray-900 font-semibold' : 'text-gray-600'); ?>">All Categories</span>
                        </label>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <label class="flex items-center cursor-pointer hover:bg-gray-50 -mx-2 px-2 py-1 rounded" wire:click="selectCategory('<?php echo e($cat->id); ?>')">
                            <input type="radio" name="category" value="<?php echo e($cat->id); ?>" <?php echo e($category == $cat->id ? 'checked' : ''); ?> class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300" readonly>
                            <span class="ml-2 text-sm text-gray-600"><?php echo e($cat->name); ?> <span class="text-xs text-gray-400">(<?php echo e($cat->jobs_count); ?>)</span></span>
                        </label>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm p-5">
                    ...
                    <div class="space-y-2">
                        <label class="flex items-center cursor-pointer hover:bg-gray-50 -mx-2 px-2 py-1 rounded" wire:click="selectExperience('')">
                            <input type="radio" name="experience" value="" <?php echo e($experience === '' ? 'checked' : ''); ?> class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300" readonly>
                            <span class="ml-2 text-sm <?php echo e(empty($experience) ? 'text-gray-900 font-semibold' : 'text-gray-600'); ?>">All Levels</span>
                        </label>
                        <label class="flex items-center cursor-pointer hover:bg-gray-50 -mx-2 px-2 py-1 rounded" wire:click="selectExperience('entry')">
                            <input type="radio" name="experience" value="entry" <?php echo e($experience === 'entry' ? 'checked' : ''); ?> class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300" readonly>
                        ...
                        <label class="flex items-center cursor-pointer hover:bg-gray-50 -mx-2 px-2 py-1 rounded" wire:click="selectExperience('mid')">
                            <input type="radio" name="experience" value="mid" <?php echo e($experience === 'mid' ? 'checked' : ''); ?> class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300" readonly>
                        ...
                        <label class="flex items-center cursor-pointer hover:bg-gray-50 -mx-2 px-2 py-1 rounded" wire:click="selectExperience('senior')">
                            <input type="radio" name="experience" value="senior" <?php echo e($experience === 'senior' ? 'checked' : ''); ?> class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300" readonly>
                        ...
                        <label class="flex items-center cursor-pointer hover:bg-gray-50 -mx-2 px-2 py-1 rounded" wire:click="selectExperience('lead')">
                            <input type="radio" name="experience" value="lead" <?php echo e($experience === 'lead' ? 'checked' : ''); ?> class="h-4 w-4 text-blue-600 focus:ring-blue-500 border-gray-300" readonly>
                ...
                <div class="bg-white rounded-xl shadow-sm p-5">
                    <div class="flex items-center justify-between">
                        ...
                        <button wire:click="$toggle('isRemote')" 
                                type="button" 
                                class="<?php echo e($isRemote ? 'bg-blue-600' : 'bg-gray-200'); ?> relative inline-flex flex-shrink-0 h-6 w-11 border-2 border-transparent rounded-full cursor-pointer transition-colors ease-in-out duration-200 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500" 
                                role="switch" 
                                aria-checked="<?php echo e($isRemote ? 'true' : 'false'); ?>">
                            <span class="<?php echo e($isRemote ? 'translate-x-5' : 'translate-x-0'); ?> pointer-events-none inline-block h-5 w-5 rounded-full bg-white shadow transform ring-0 transition ease-in-out duration-200"></span>
                        </button>
                    </div>
                </div>
            </div>
            ...
            <div class="w-full lg:w-3/4">
                ...
                <div class="flex justify-between items-center mb-4">
                    <p class="text-sm text-gray-600">Showing <span class="font-bold text-gray-900"><?php echo e($jobs->firstItem() ?? 0); ?> - <?php echo e($jobs->lastItem() ?? 0); ?></span> of <span class="font-bold text-gray-900"><?php echo e($jobs->total()); ?></span> jobs</p>
                </div>
                    ...
                    <div class="group relative bg-white rounded-xl p-6 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300 border border-gray-100">
                        <div class="flex flex-col sm:flex-row gap-6">
                            ...
                            <div class="flex-shrink-0">
                                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($job->company && $job->company->logo): ?>
                                    <img class="h-16 w-16 rounded-lg object-cover bg-white border border-gray-100" src="<?php echo e($job->company->logo_url); ?>" alt="<?php echo e($job->company->name); ?>">
                                <?php else: ?>
                                    <div class="h-16 w-16 rounded-lg bg-gradient-to-br from-blue-50 to-blue-100 flex items-center justify-center text-blue-600 font-bold text-xl border border-blue-100">
                                        <?php echo e(substr($job->company->company_name ?? 'C', 0, 1)); ?>
                            ...
                            <div class="flex-1 min-w-0">
                                <div class="flex items-center justify-between mb-2">
                                    ...
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($job->created_at->diffInDays() < 3): ?>
                                ...
                                <div class="flex items-center text-sm text-gray-500 mb-4">
                                    <span class="font-medium text-gray-900"><?php echo e($job->company->company_name ?? 'Confidential'); ?></span>
                                    ...
                                    <span class="flex items-center">
                                        ...
                                        <?php echo e($job->city); ?><?php echo e($job->country ? ', ' . $job->country : ''); ?>
                                ...
                                <div class="flex flex-wrap gap-2">
                                    ...
                                    <span class="inline-flex items-center px-2.5 py-0.5 rounded-md text-xs font-medium bg-purple-50 text-purple-700 border border-purple-100">
                                        <?php echo e($job->experience_level ? ucfirst($job->experience_level) . ' Level' : 'Experience N/A'); ?>

                                    </span>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($job->min_salary): ?>
                            ...
                            <div class="hidden sm:flex flex-col justify-center items-end pl-4">
                                <span class="text-gray-400 text-xs mb-2"><?php echo e($job->created_at->diffForHumans()); ?></span>
...
</div><?php /**PATH /var/www/placemenet/resources/views/livewire/job-search.blade.php ENDPATH**/ ?>