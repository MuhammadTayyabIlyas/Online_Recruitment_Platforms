<?php $__env->startSection('title', 'Data Privacy & GDPR Compliance'); ?>
...
<div class="py-10">
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 space-y-8">
        <div class="bg-white/95 rounded-3xl shadow-2xl p-8 md:p-12">
            ...
            <div class="mt-6 flex flex-wrap gap-3">
                <a href="#cookies-policy" class="inline-flex items-center gap-2 px-5 py-3 rounded-xl bg-blue-600 text-white font-semibold shadow hover:bg-blue-700 transition">
                    <?php echo e(__('View Cookies Policy')); ?>

                    <svg class="w-4 h-4" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 3h7m0 0v7m0-7L10 14" />
                    </svg>
                </a>
                <a href="<?php echo e(route('home')); ?>" class="inline-flex items-center gap-2 px-5 py-3 rounded-xl border border-gray-200 text-gray-700 font-semibold hover:border-blue-200 hover:text-blue-700 transition">
        ...
        <div id="cookies-policy" class="bg-white rounded-2xl shadow-xl p-6 space-y-4 scroll-mt-20">
            ...
            <a href="<?php echo e(route('home')); ?>" class="inline-flex items-center gap-2 px-5 py-3 rounded-xl bg-blue-600 text-white font-semibold shadow hover:bg-blue-700 transition">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/placemenet/resources/views/privacy.blade.php ENDPATH**/ ?>