...
<div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="bg-white shadow-lg rounded-lg border border-gray-200">
        ...
        <form action="<?php echo e(route('admin.users.store')); ?>" method="POST" class="p-6 space-y-6">
            <?php echo csrf_field(); ?>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <select name="user_type" id="user_type"
                            ...
                            <option value="job_seeker" <?php echo e(old('user_type') === 'job_seeker' ? 'selected' : ''); ?>>Job Seeker</option>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
            ...
            <div class="flex justify-between items-center pt-6">
                <a href="<?php echo e(route('admin.users.index')); ?>" class="inline-flex items-center text-gray-600 hover:text-gray-900 font-medium">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/placemenet/resources/views/admin/users/create.blade.php ENDPATH**/ ?>