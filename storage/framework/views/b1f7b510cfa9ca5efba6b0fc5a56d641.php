<?php $__env->startSection('title', 'Login - PlaceMeNet'); ?>
        ...
        <div class="max-w-md w-full">
            ...
            <div class="bg-white rounded-2xl shadow-2xl p-8 backdrop-blur-sm transform transition-all duration-500 hover:shadow-3xl">
                ...
                <form class="space-y-6" action="<?php echo e(route('login')); ?>" method="POST">
                    ...
                    <a href="<?php echo e(route('linkedin.login')); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/placemenet/resources/views/auth/login.blade.php ENDPATH**/ ?>