<?php $__env->startSection('title', 'Application Details - ' . $application->user->name); ?>

<?php $__env->startSection('content'); ?>
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <!-- Header -->
    <div class="mb-6">
        <a href="<?php echo e(route('admin.applications.index')); ?>" class="inline-flex items-center text-indigo-600 hover:text-indigo-900 font-medium mb-4">
                ...
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500 mt-1">
                            Company: <span class="font-medium"><?php echo e($application->job->company->company_name ?? 'N/A'); ?></span> •
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div class="p-6 space-y-4">
                    <div class="flex items-start">
                        ...
                        <div>
                            ...
                            <p class="text-sm font-medium text-gray-900"><?php echo e($application->user->email); ?></p>
                        </div>
                    </div>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($application->user->phone): ?>
                        <div class="flex items-start">
                            ...
                            <div>
                                ...
                                <p class="text-sm font-medium text-gray-900"><?php echo e($application->user->phone); ?></p>
                            </div>
                        </div>
                ...
                <div class="p-6">
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($application->resume_path): ?>
                        <div class="flex gap-3">
                            <a href="<?php echo e(route('admin.applications.resume.view', $application)); ?>" target="_blank"
                            ...
                            <a href="<?php echo e(route('admin.applications.resume', $application)); ?>"
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                    <div class="bg-gradient-to-r from-indigo-50 to-purple-50 px-6 py-4 border-b border-gray-200">
                        <h2 class="text-lg font-bold text-gray-900 flex items-center">
                            ...
                            Additional Documents (<?php echo e($application->user->documents->count()); ?>)
                        </h2>
                    </div>
                    <div class="p-6">
                        <div class="space-y-3">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $application->user->documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $document): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg border border-gray-200 hover:border-indigo-300 transition">
                                    <div class="flex items-center flex-1">
                                        ...
                                        <div class="ml-4">
                                            <p class="text-sm font-medium text-gray-900"><?php echo e($document->document_name ?? $document->original_name); ?></p>
                                            <p class="text-xs text-gray-500"><?php echo e($document->file_size_formatted); ?> • <?php echo e($document->created_at->format('M d, Y')); ?></p>
                                        </div>
                                    </div>
                                    <div class="flex gap-2">
                                        <a href="<?php echo e(route('admin.applications.document.view', $document->id)); ?>" target="_blank"
                                        ...
                                        <a href="<?php echo e(route('admin.applications.document.download', $document->id)); ?>"
        ...
        <div class="lg:col-span-1">
            ...
            <div class="bg-white rounded-lg shadow-lg border-2 border-red-300 overflow-hidden">
                ...
                <form action="<?php echo e(route('admin.applications.update-status', $application)); ?>" method="POST" class="p-6 space-y-4">
                    <?php echo csrf_field(); ?>
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                    ...
                    <div class="p-6">
                        <div class="space-y-4">
                            ...
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $notesList; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $note): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php
                                ...
                                <div class="bg-gray-50 rounded-lg p-4 border-l-4 border-amber-500">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($timestamp): ?>
                                        <div class="flex items-center text-xs text-gray-500 mb-2">
                                            ...
                                            <?php echo e(\Carbon\Carbon::parse($timestamp)->format('M d, Y \a\t h:i A')); ?>

                                        </div>
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <p class="text-sm text-gray-700 whitespace-pre-wrap"><?php echo e(trim($content)); ?></p>
                                </div>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                        </div>
                    </div>
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
                    ...
                    <div class="p-6 space-y-2 text-sm">
                        <div class="flex justify-between">
                            ...
                            <span class="font-medium text-gray-900"><?php echo e($application->reviewed_at->format('M d, Y h:i A')); ?></span>
                        </div>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($application->reviewed_by): ?>
                            <div class="flex justify-between">
                                <span class="text-gray-600">Reviewed By:</span>
                                <span class="font-medium text-gray-900"><?php echo e(\App\Models\User::find($application->reviewed_by)?->name ?? 'Unknown'); ?></span>
                            </div>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/placemenet/resources/views/admin/applications/show.blade.php ENDPATH**/ ?>