                                ...
                                <tr>
                                    <td style="padding: 25px;">
                                        ...
                                        <div style="margin-bottom: 12px;">
                                            ...
                                            <span style="color: #0c4a6e; font-size: 14px; font-weight: 500;"><?php echo e($application->job->company->company_name); ?></span>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <span style="color: #0c4a6e; font-size: 14px;"><?php echo e($application->created_at->format('F d, Y \a\t h:i A')); ?></span>
                                        </div>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        <td style="background-color: #f9fafb; padding: 30px; text-align: center; border-top: 1px solid #e5e7eb;">
                            <p style="margin: 0 0 15px; color: #6b7280; font-size: 14px;">
                                Need help? <a href="<?php echo e(config('app.url')); ?>" style="color: #3b82f6; text-decoration: none; font-weight: 600;">Visit our Help Center</a>
                            </p>

                            <div style="margin: 20px 0;">
                                <a href="<?php echo e(config('app.url')); ?>" style="display: inline-block; margin: 0 8px; color: #9ca3af; text-decoration: none; font-size: 13px;">Dashboard</a>
...
<?php /**PATH /var/www/placemenet/resources/views/emails/application-submitted.blade.php ENDPATH**/ ?>