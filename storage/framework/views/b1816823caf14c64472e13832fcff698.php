        ...
        <div class="bg-white/95 backdrop-blur-sm p-8 rounded-2xl shadow-2xl ring-1 ring-white/20">
            ...
            <div class="text-center mb-8">
                <div class="mx-auto h-14 w-14 rounded-xl bg-white shadow-md ring-2 ring-blue-100 flex items-center justify-center overflow-hidden">
                    <img src="<?php echo e(asset('assets/images/logo.jpg')); ?>" alt="PlaceMeNet logo" class="h-12 w-12 object-cover">
                </div>
            ...
            <form class="space-y-6" action="<?php echo e(route('register')); ?>" method="POST" novalidate>
                <?php echo csrf_field(); ?>
                ...
                <div>
                    ...
                    <input id="name"
                           ...
                           autocomplete="name"
                           autofocus
                           class="appearance-none relative block w-full px-3 py-3 border <?php echo e($errors->has('name') ? 'border-red-300 ring-2 ring-red-100' : 'border-gray-300'); ?> placeholder-gray-500 text-gray-900 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm transition-all duration-200"
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div>
                    ...
                    <input id="email"
                           ...
                           required
                           autocomplete="email"
                           class="appearance-none relative block w-full px-3 py-3 border <?php echo e($errors->has('email') ? 'border-red-300 ring-2 ring-red-100' : 'border-gray-300'); ?> placeholder-gray-500 text-gray-900 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm transition-all duration-200"
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div>
                    ...
                    <input id="phone"
                           ...
                           autocomplete="tel"
                           class="appearance-none relative block w-full px-3 py-3 border <?php echo e($errors->has('phone') ? 'border-red-300 ring-2 ring-red-100' : 'border-gray-300'); ?> placeholder-gray-500 text-gray-900 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm transition-all duration-200"
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div>
                    ...
                    <select id="user_type"
                            name="user_type"
                            required
                            class="appearance-none relative block w-full px-3 py-3 border <?php echo e($errors->has('user_type') ? 'border-red-300 ring-2 ring-red-100' : 'border-gray-300'); ?> text-gray-900 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm transition-all duration-200">
                        <option value="">Select Account Type</option>
                        <option value="employer" <?php echo e(old('user_type') === 'employer' ? 'selected' : ''); ?>>Employer - Post Jobs & Find Candidates</option>
                        <option value="job_seeker" <?php echo e(old('user_type') === 'job_seeker' ? 'selected' : ''); ?>>Job Seeker - Find & Apply to Jobs</option>
                        <option value="educational_institution" <?php echo e(old('user_type') === 'educational_institution' ? 'selected' : ''); ?>>Educational Institution - Publish Study Programs</option>
                        <option value="student" <?php echo e(old('user_type') === 'student' ? 'selected' : ''); ?>>Student - Browse & Apply to Study Programs</option>
                    </select>
                ...
                <div>
                    ...
                    <div class="relative">
                        <input id="password"
                               ...
                               class="appearance-none relative block w-full px-3 py-3 pr-10 border <?php echo e($errors->has('password') ? 'border-red-300 ring-2 ring-red-100' : 'border-gray-300'); ?> placeholder-gray-500 text-gray-900 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm transition-all duration-200"
                ...
                <div>
                    ...
                    <div class="relative">
                        <input id="password_confirmation"
                               ...
                               required
                               autocomplete="new-password"
                               class="appearance-none relative block w-full px-3 py-3 pr-10 border <?php echo e($errors->has('password_confirmation') ? 'border-red-300 ring-2 ring-red-100' : 'border-gray-300'); ?> placeholder-gray-500 text-gray-900 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm transition-all duration-200"
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="flex items-start">
                    ...
                    <div class="ml-3">
                        <p class="text-xs text-gray-600">
                            By signing up, you agree to our <a href="<?php echo e(route('privacy')); ?>" class="text-indigo-600 hover:text-indigo-500 font-medium">Privacy Policy</a> and <a href="<?php echo e(route('terms')); ?>" class="text-indigo-600 hover:text-indigo-500 font-medium">Terms of Service</a>. We'll protect your data with enterprise-grade security.
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="text-center">
                <p class="text-sm text-gray-600">
                    ...
                    <a href="<?php echo e(route('login')); ?>" class="font-medium text-indigo-600 hover:text-indigo-500 transition-colors">
                        Sign in securely
                    </a>
                </p>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/placemenet/resources/views/auth/register.blade.php ENDPATH**/ ?>