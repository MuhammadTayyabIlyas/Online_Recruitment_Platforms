...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white shadow rounded-lg p-6">
            ...
            <dl class="space-y-4">
                <div>
                    ...
                    <dd class="mt-1 text-sm text-gray-900"><?php echo e($settings['app_name']); ?></dd>
                </div>
                <div>
                    <dt class="text-sm font-medium text-gray-500">Application URL</dt>
                    <dd class="mt-1 text-sm text-gray-900"><?php echo e($settings['app_url']); ?></dd>
                </div>
                <div>
                    <dt class="text-sm font-medium text-gray-500">Mail From Address</dt>
                    <dd class="mt-1 text-sm text-gray-900"><?php echo e($settings['mail_from_address'] ?? 'Not configured'); ?></dd>
                </div>
                <div>
                    <dt class="text-sm font-medium text-gray-500">Mail From Name</dt>
                    <dd class="mt-1 text-sm text-gray-900"><?php echo e($settings['mail_from_name'] ?? 'Not configured'); ?></dd>
                </div>
            </dl>
        </div>
        ...
        <div class="bg-white shadow rounded-lg p-6">
            ...
            <dl class="space-y-4">
                <div>
                    ...
                    <dd class="mt-1 text-sm text-gray-900"><?php echo e($systemInfo['php_version']); ?></dd>
                </div>
                <div>
                    <dt class="text-sm font-medium text-gray-500">Laravel Version</dt>
                    <dd class="mt-1 text-sm text-gray-900"><?php echo e($systemInfo['laravel_version']); ?></dd>
                </div>
                <div>
                    <dt class="text-sm font-medium text-gray-500">Environment</dt>
                    <dd class="mt-1">
                        <span class="px-2 py-1 text-xs font-medium rounded-full <?php echo e($systemInfo['environment'] === 'production' ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800'); ?>">
                ...
                <div>
                    ...
                    <dd class="mt-1">
                        <span class="px-2 py-1 text-xs font-medium rounded-full <?php echo e($systemInfo['debug_mode'] === 'Enabled' ? 'bg-red-100 text-red-800' : 'bg-green-100 text-green-800'); ?>">
                            <?php echo e($systemInfo['debug_mode']); ?>
                ...
                <div>
                    ...
                    <dd class="mt-1 text-sm text-gray-900"><?php echo e($systemInfo['cache_driver']); ?></dd>
                </div>
                <div>
                    <dt class="text-sm font-medium text-gray-500">Session Driver</dt>
                    <dd class="mt-1 text-sm text-gray-900"><?php echo e($systemInfo['session_driver']); ?></dd>
                </div>
                <div>
                    <dt class="text-sm font-medium text-gray-500">Queue Driver</dt>
                    <dd class="mt-1 text-sm text-gray-900"><?php echo e($systemInfo['queue_driver']); ?></dd>
                </div>
            </dl>
        </div>
        ...
        <div class="bg-white shadow rounded-lg p-6 lg:col-span-2">
            ...
            <form action="<?php echo e(route('admin.settings.change-password')); ?>" method="POST" class="max-w-xl">
                <?php echo csrf_field(); ?>
                <div class="space-y-4">
                    <div>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
        ...
        <div class="bg-white shadow rounded-lg p-6 lg:col-span-2">
            ...
            <p class="text-sm text-gray-600 mb-4">
                Upload a valid XML sitemap to improve Google visibility. The file will be published at <a class="text-indigo-600 underline" href="<?php echo e(url('sitemap.xml')); ?>" target="_blank" rel="noopener">/sitemap.xml</a>.
            </p>
            <form action="<?php echo e(route('admin.settings.sitemap.upload')); ?>" method="POST" enctype="multipart/form-data" class="flex flex-col md:flex-row md:items-center gap-4">
                <?php echo csrf_field(); ?>
                <div class="flex-1">
                ...
                <div class="flex gap-3">
                    ...
                    <a href="<?php echo e(url('sitemap.xml')); ?>" target="_blank" rel="noopener" class="inline-flex items-center px-5 py-2.5 border border-gray-200 rounded-md text-gray-700 hover:border-indigo-200 hover:text-indigo-700">
                        View Current
                    </a>
                </div>
            </form>
        ...
        <div class="bg-white shadow rounded-lg p-6 lg:col-span-2">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                <div class="text-center p-4 bg-gray-50 rounded-lg">
                    <p class="text-2xl font-bold text-indigo-600"><?php echo e(\App\Models\User::count()); ?></p>
                    <p class="text-sm text-gray-500">Total Users</p>
                </div>
                <div class="text-center p-4 bg-gray-50 rounded-lg">
                    <p class="text-2xl font-bold text-green-600"><?php echo e(\App\Models\Job::count()); ?></p>
                    <p class="text-sm text-gray-500">Total Jobs</p>
                </div>
                <div class="text-center p-4 bg-gray-50 rounded-lg">
                    <p class="text-2xl font-bold text-yellow-600"><?php echo e(\App\Models\Company::count()); ?></p>
                    <p class="text-sm text-gray-500">Companies</p>
                </div>
                <div class="text-center p-4 bg-gray-50 rounded-lg">
                    <p class="text-2xl font-bold text-purple-600"><?php echo e(\App\Models\JobApplication::count()); ?></p>
        ...
        <div class="bg-white shadow rounded-lg p-6 lg:col-span-2">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="border-2 border-dashed border-gray-300 rounded-lg p-6">
                    ...
                    <a href="<?php echo e(route('admin.csv.companies-sample')); ?>" class="inline-flex items-center text-sm text-indigo-600 hover:text-indigo-700 mb-4">
                    ...
                    <form action="<?php echo e(route('admin.csv.import-companies')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="mb-4">
                ...
                <div class="border-2 border-dashed border-gray-300 rounded-lg p-6">
                    ...
                    <a href="<?php echo e(route('admin.csv.jobs-sample')); ?>" class="inline-flex items-center text-sm text-indigo-600 hover:text-indigo-700 mb-4">
                        <svg class="w-4 h-4 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                        </svg>
                        Download Sample CSV
                    ...
                    <form action="<?php echo e(route('admin.csv.import-jobs')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="mb-4">
                            <input type="file" name="csv_file" accept=".csv" required
                                   class="block w-full text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-indigo-50 file:text-indigo-700 hover:file:bg-indigo-100">
        ...
        <div class="bg-white shadow rounded-lg p-6 lg:col-span-2">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <a href="<?php echo e(route('admin.csv.export-jobs')); ?>" class="flex items-center justify-center px-6 py-4 bg-gradient-to-r from-green-50 to-green-100 border-2 border-green-200 text-green-800 rounded-lg hover:from-green-100 hover:to-green-200 transition-all">
                ...
                <a href="<?php echo e(route('admin.csv.export-candidates')); ?>" class="flex items-center justify-center px-6 py-4 bg-gradient-to-r from-blue-50 to-blue-100 border-2 border-blue-200 text-blue-800 rounded-lg hover:from-blue-100 hover:to-blue-200 transition-all">
                    <svg class="w-6 h-6 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/placemenet/resources/views/admin/settings/index.blade.php ENDPATH**/ ?>