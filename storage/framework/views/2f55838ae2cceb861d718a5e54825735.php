...
<?php $__env->startSection('page-title', 'Job Management'); ?>
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 lg:grid-cols-6 gap-4 mb-8">
        ...
        <div class="bg-gradient-to-br from-indigo-500 to-purple-600 rounded-xl shadow-lg p-5 text-white">
            ...
            <p class="text-2xl font-bold"><?php echo e(number_format($totalJobs)); ?></p>
        ...
        <div class="bg-gradient-to-br from-green-500 to-emerald-600 rounded-xl shadow-lg p-5 text-white">
            ...
            <p class="text-2xl font-bold"><?php echo e(number_format($publishedCount)); ?></p>
        ...
        <div class="bg-gradient-to-br from-gray-500 to-slate-600 rounded-xl shadow-lg p-5 text-white">
            ...
            <p class="text-2xl font-bold"><?php echo e(number_format($draftCount)); ?></p>
        ...
        <div class="bg-gradient-to-br from-red-500 to-pink-600 rounded-xl shadow-lg p-5 text-white">
            ...
            <p class="text-2xl font-bold"><?php echo e(number_format($closedCount)); ?></p>
        ...
        <div class="bg-gradient-to-br from-yellow-500 to-amber-600 rounded-xl shadow-lg p-5 text-white">
            ...
            <p class="text-2xl font-bold"><?php echo e(number_format($featuredCount)); ?></p>
        ...
        <div class="bg-gradient-to-br from-orange-500 to-red-600 rounded-xl shadow-lg p-5 text-white">
            ...
            <p class="text-2xl font-bold"><?php echo e(number_format($urgentCount)); ?></p>
    ...
    <div class="bg-white rounded-xl shadow-md border border-gray-200 p-6 mb-6">
        ...
        <form action="<?php echo e(route('admin.jobs.index')); ?>" method="GET" class="grid grid-cols-1 md:grid-cols-6 gap-4">
            ...
            <div>
                ...
                <div class="flex flex-col gap-2 pt-1">
                    ...
                    <label class="inline-flex items-center">
                        <input type="checkbox" name="urgent" value="1" <?php echo e(request('urgent') ? 'checked' : ''); ?>
            ...
            <div class="flex items-end gap-2">
                ...
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request()->hasAny(['search', 'status', 'category', 'featured', 'urgent'])): ?>
                    <a href="<?php echo e(route('admin.jobs.index')); ?>" class="px-4 py-2 bg-gray-100 text-gray-700 font-medium rounded-lg hover:bg-gray-200 transition-colors">
                        Clear
                    </a>
    ...
    <!-- Bulk Actions -->
    <form action="<?php echo e(route('admin.jobs.bulk-action')); ?>" method="POST" id="bulkForm">
        <?php echo csrf_field(); ?>
            ...
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors <?php echo e($job->trashed() ? 'bg-red-50' : ''); ?>">
                            <td class="px-6 py-4">
                                <input type="checkbox" name="jobs[]" value="<?php echo e($job->id); ?>" class="job-checkbox rounded border-gray-300 text-indigo-600 focus:ring-indigo-500">
                            </td>
                            <td class="px-6 py-4">
                                <div class="text-sm font-semibold text-gray-900"><?php echo e($job->title); ?></div>
                                ...
                                <div class="flex gap-2 mt-2">
                                    ...
                                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($job->is_urgent): ?>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm font-medium text-gray-900"><?php echo e($job->company->name ?? 'N/A'); ?></div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="px-3 py-1 inline-flex items-center text-xs font-bold rounded-full
                                    ...
                                    <?php echo e($job->status === 'closed' ? 'bg-red-100 text-red-800' : ''); ?>

                                    <?php echo e($job->status === 'expired' ? 'bg-orange-100 text-orange-800' : ''); ?>">
                                    <span class="w-2 h-2 rounded-full mr-2
                                        <?php echo e($job->status === 'published' ? 'bg-green-500' : ''); ?>

                                        <?php echo e($job->status === 'draft' ? 'bg-gray-500' : ''); ?>

                                        <?php echo e($job->status === 'closed' ? 'bg-red-500' : ''); ?>

                                        <?php echo e($job->status === 'expired' ? 'bg-orange-500' : ''); ?>"></span>
                            ...
                            <td class="px-6 py-4 text-sm text-gray-600">
                                <div class="flex items-center">
                                    ...
                                    <?php echo e($job->published_at ? $job->published_at->format('M d, Y') : 'Not set'); ?>
                                ...
                                <div class="flex items-center mt-1">
                                    ...
                                    <?php echo e($job->expires_at ? $job->expires_at->format('M d, Y') : 'No expiry'); ?>
                            ...
                            <td class="px-6 py-4 text-sm">
                                <div class="flex items-center text-gray-600">
                                    ...
                                    <span class="font-semibold text-blue-600"><?php echo e($job->views_count); ?></span>
                                </div>
                                <div class="flex items-center text-gray-600 mt-1">
                                    <svg class="w-4 h-4 mr-1 text-green-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                                    </svg>
                                    <span class="font-semibold text-green-600"><?php echo e($job->applications_count); ?></span>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm">
                                <div class="flex justify-end gap-2">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$job->trashed()): ?>
                                        <a href="<?php echo e(route('admin.jobs.edit', $job->id)); ?>" class="inline-flex items-center px-3 py-1.5 bg-blue-100 text-blue-700 rounded-lg hover:bg-blue-200 font-medium transition-colors" title="Edit Job">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z"/>
                                            </svg>
                                        </a>
                                        <form action="<?php echo e(route('admin.jobs.toggle-featured', $job->id)); ?>" method="POST" class="inline">
                                            <?php echo csrf_field(); ?>
                                            <?php echo method_field('PATCH'); ?>
                                            <button type="submit" class="inline-flex items-center px-3 py-1.5 <?php echo e($job->is_featured ? 'bg-yellow-100 text-yellow-700 hover:bg-yellow-200' : 'bg-gray-100 text-gray-700 hover:bg-gray-200'); ?> rounded-lg font-medium transition-colors" title="<?php echo e($job->is_featured ? 'Remove Featured' : 'Mark Featured'); ?>">
                                                <svg class="w-4 h-4" fill="<?php echo e($job->is_featured ? 'currentColor' : 'none'); ?>" stroke="currentColor" viewBox="0 0 20 20">
                                                    <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z"/>
                                                </svg>
                                            </button>
                                        </form>
                                        <form action="<?php echo e(route('admin.jobs.destroy', $job->id)); ?>" method="POST" class="inline"
                                    ...
                                    <?php else: ?>
                                        <form action="<?php echo e(route('admin.jobs.restore', $job->id)); ?>" method="POST" class="inline">
                                            <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/placemenet/resources/views/admin/jobs/index.blade.php ENDPATH**/ ?>