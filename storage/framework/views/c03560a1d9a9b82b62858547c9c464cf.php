    ...
    <div class="email-container">
        ...
        <div class="email-body">
            ...
            <div class="content-block">
                ...
                <div class="details-table">
                    <div class="details-row">
                        ...
                        <div class="details-value"><?php echo e($time); ?></div>
                    </div>
                    <div class="details-row">
                        <div class="details-label">Device</div>
                        <div class="details-value"><?php echo e($device['browser'] ?? 'Unknown'); ?> on <?php echo e($device['os'] ?? 'Unknown'); ?></div>
                    </div>
                    <div class="details-row">
                        <div class="details-label">IP Address</div>
                        <div class="details-value"><?php echo e($ip); ?></div>
                    </div>
                    <div class="details-row">
                        <div class="details-label">Location</div>
                        <div class="details-value">
                            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(function_exists('geoip')): ?>
                                <?php echo e(geoip($ip)->country ?? 'Unknown'); ?>, <?php echo e(geoip($ip)->city ?? 'Unknown'); ?>
            ...
            <div class="action-buttons">
                <a href="<?php echo e(url('/account/security')); ?>" class="btn btn-primary">
                    Review Account Activity
                </a>
                <a href="<?php echo e(url('/account/password')); ?>" class="btn btn-secondary">
                    Change Password
                </a>
            </div>
        ...
        <div class="email-footer">
            ...
            <p>
                <a href="<?php echo e(url('/account/security')); ?>">Manage your security settings</a> |
                <a href="<?php echo e(url('/help')); ?>">Contact Support</a>
            </p>
...
<?php /**PATH /var/www/placemenet/resources/views/emails/new-device-alert.blade.php ENDPATH**/ ?>