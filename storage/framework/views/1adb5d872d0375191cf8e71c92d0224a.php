<?php $__env->startSection('title', 'Blog - Latest Insights & Guides'); ?>
...
<div class="bg-gradient-to-r from-blue-600 to-purple-600 text-white py-16">
    <div class="container mx-auto px-4">
        <div class="max-w-3xl mx-auto text-center">
            ...
            <!-- Search Form -->
            <form action="<?php echo e(route('blogs.index')); ?>" method="GET" class="relative max-w-2xl mx-auto">
                <input type="text"
                       name="search"
...
<div class="container mx-auto px-4 py-12">
    <div class="flex flex-wrap lg:flex-nowrap gap-8">
        ...
        <div class="w-full lg:w-3/4">
            <!-- Featured Blogs -->
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($featuredBlogs->count() > 0 && !request()->has('search') && !request()->has('category')): ?>
                <div class="mb-12">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-<?php echo e(min(3, $featuredBlogs->count())); ?> gap-6">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $featuredBlogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <a href="<?php echo e(route('blogs.show', $blog->slug)); ?>" class="group">
                                <div class="bg-white rounded-lg shadow-md hover:shadow-xl transition overflow-hidden h-full flex flex-col">
                                    ...
                                    <div class="p-6 flex-1 flex flex-col">
                                        ...
                                        <p class="text-gray-600 mb-4 flex-1">
                                            <?php echo e(Str::limit($blog->excerpt, 120)); ?>
            ...
            <div class="mb-8 flex flex-wrap items-center justify-between gap-4">
                <div>
                    <h2 class="text-2xl font-bold text-gray-900">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(request()->has('category')): ?>
                            <?php echo e($selectedCategory->name); ?>

                        <?php elseif(request()->has('search')): ?>
                            Search Results
                        <?php else: ?>
                            Latest Articles
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div class="flex items-center gap-3">
                    ...
                    <select name="sort"
                            id="sort"
                            onchange="window.location.href='<?php echo e(route('blogs.index')); ?>?' + new URLSearchParams({...Object.fromEntries(new URLSearchParams(window.location.search)), sort: this.value})"
        ...
        <aside class="w-full lg:w-1/4">
                ...
                <ul class="space-y-2">
                    <li>
                        <a href="<?php echo e(route('blogs.index')); ?>"
                           class="flex items-center justify-between px-3 py-2 rounded-lg transition <?php echo e(!request()->has('category') ? 'bg-blue-50 text-blue-700 font-medium' : 'text-gray-700 hover:bg-gray-50'); ?>">
                            <span>All Articles</span>
                            <span class="text-sm"><?php echo e($totalBlogs); ?></span>
                        </a>
                    </li>
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <li>
                            <a href="<?php echo e(route('blogs.category', $category->slug)); ?>"
                               class="flex items-center justify-between px-3 py-2 rounded-lg transition <?php echo e(request('category') == $category->id ? 'bg-blue-50 text-blue-700 font-medium' : 'text-gray-700 hover:bg-gray-50'); ?>">
                                <span><?php echo e($category->icon); ?> <?php echo e($category->name); ?></span>
                                <span class="text-sm"><?php echo e($category->blogs_count); ?></span>
                            </a>
                        </li>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </ul>
            ...
            <!-- Popular Posts -->
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($popularBlogs->count() > 0): ?>
                <div class="bg-white rounded-lg shadow-md p-6">
                    <h3 class="text-xl font-bold text-gray-900 mb-4">Popular Articles</h3>

                    <ul class="space-y-4">
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $popularBlogs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $blog): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <li>
                                <a href="<?php echo e(route('blogs.show', $blog->slug)); ?>" class="group flex gap-3">
                                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($blog->featured_image): ?>
                                        <img src="<?php echo e(Storage::url($blog->featured_image)); ?>"
                                             alt="<?php echo e($blog->featured_image_alt); ?>"
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/placemenet/resources/views/blogs/index.blade.php ENDPATH**/ ?>