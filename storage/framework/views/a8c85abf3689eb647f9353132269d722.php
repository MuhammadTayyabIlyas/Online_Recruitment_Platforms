                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            <p style="margin: 0 0 20px; color: #1f2937; font-size: 16px; line-height: 1.6;">
                                Hello <strong><?php echo e($application->job->user->name); ?></strong>,
                            </p>
                                ...
                                <tr>
                                    <td style="padding: 25px;">
                                        ...
                                        <div>
                                            ...
                                            <span style="color: #064e3b; font-size: 14px;"><?php echo e($application->job->created_at->diffForHumans()); ?></span>
                                        </div>
                                    </td>
                                </tr>
                            </table>
                                ...
                                <tr>
                                    <td style="padding: 25px;">
                                        ...
                                        <div style="margin-bottom: 12px;">
                                            ...
                                            <span style="color: #1e3a8a; font-size: 14px;"><?php echo e($application->user->email); ?></span>
                                        </div>
                                        ...
                                        <div style="margin-bottom: 12px;">
                                            ...
                                            <span style="color: #1e3a8a; font-size: 14px;"><?php echo e($application->user->phone); ?></span>
                                        </div>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($application->user->profile?->headline): ?>
                                        <div style="margin-bottom: 12px;">
                                            <span style="color: #1e40af; font-size: 14px; font-weight: 600;">💼 Headline:</span>
                                            <span style="color: #1e3a8a; font-size: 14px;"><?php echo e($application->user->profile->headline); ?></span>
                                        </div>
                                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>

                                        <div>
                                            <span style="color: #1e40af; font-size: 14px; font-weight: 600;">⏰ Applied:</span>
                                            <span style="color: #1e3a8a; font-size: 14px;"><?php echo e($application->created_at->format('F d, Y \a\t h:i A')); ?></span>
                                        </div>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <div style="background-color: #fef3c7; border-left: 4px solid #f59e0b; padding: 20px; border-radius: 8px; margin-bottom: 30px;">
                                ...
                                <p style="margin: 0; color: #78350f; font-size: 14px; line-height: 1.6; white-space: pre-line;">
                                    <?php echo e(\Illuminate\Support\Str::limit($application->cover_letter, 250)); ?>
                                ...
                                <table role="presentation" style="width: 100%; border-collapse: collapse;">
                                    <tr>
                                        <td style="padding: 8px 0;">
                                            <a href="<?php echo e(route('employer.applicants.show', $application)); ?>" style="color: #166534; text-decoration: none; font-size: 14px; font-weight: 600;">
                                    ...
                                    <tr>
                                        <td style="padding: 8px 0;">
                                            <a href="<?php echo e(route('employer.applicants.show', $application)); ?>#candidate-profile" style="color: #166534; text-decoration: none; font-size: 14px; font-weight: 600;">
                                    ...
                                    <tr>
                                        <td style="padding: 8px 0;">
                                            <a href="<?php echo e(route('employer.applicants.index')); ?>" style="color: #166534; text-decoration: none; font-size: 14px; font-weight: 600;">
                    ...
                    <tr>
                        <td style="background-color: #f9fafb; padding: 30px; text-align: center; border-top: 1px solid #e5e7eb;">
                            ...
                            <div style="margin: 20px 0;">
                                <a href="<?php echo e(route('employer.dashboard')); ?>" style="display: inline-block; margin: 0 8px; color: #9ca3af; text-decoration: none; font-size: 13px;">Dashboard</a>
                                <span style="color: #d1d5db;">•</span>
                                <a href="<?php echo e(route('employer.applicants.index')); ?>" style="display: inline-block; margin: 0 8px; color: #9ca3af; text-decoration: none; font-size: 13px;">All Applicants</a>
                                <span style="color: #d1d5db;">•</span>
                                <a href="<?php echo e(route('employer.jobs.index')); ?>" style="display: inline-block; margin: 0 8px; color: #9ca3af; text-decoration: none; font-size: 13px;">My Jobs</a>
                            </div>
...
<?php /**PATH /var/www/placemenet/resources/views/emails/new-application-received.blade.php ENDPATH**/ ?>