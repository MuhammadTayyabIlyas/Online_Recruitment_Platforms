...
<head>
    ...
    <title><?php echo e(config('app.name', 'PlaceMeNet')); ?> - Admin - <?php echo $__env->yieldContent('title', 'Dashboard'); ?></title>
    ...
    <div class="min-h-screen flex" x-data="{ sidebarOpen: true }">
        ...
        <aside :class="sidebarOpen ? 'w-64' : 'w-20'" class="brand-gradient text-white shadow-2xl transition-all duration-300 fixed h-full z-30 border-r border-white/10">
            ...
            <div class="flex items-center justify-between p-4 border-b border-white/10">
                <a href="<?php echo e(route('admin.dashboard')); ?>" class="flex items-center gap-3" x-show="sidebarOpen">
                    <div class="h-12 w-12 rounded-2xl bg-white/10 backdrop-blur flex items-center justify-center shadow-lg">
                        <img src="<?php echo e(asset('assets/images/logo.jpg')); ?>" alt="PlaceMeNet Admin" class="h-8 w-auto object-contain drop-shadow">
                    </div>
                ...
                <a href="<?php echo e(route('admin.dashboard')); ?>" class="block" x-show="!sidebarOpen">
            ...
            <nav class="p-4 space-y-2 text-white">
                ...
                <a href="<?php echo e(route('admin.dashboard')); ?>"
                   class="sidebar-link group flex items-center rounded-lg text-white/80 py-3 <?php echo e(request()->routeIs('admin.dashboard') ? 'active' : ''); ?>"
                ...
                <a href="<?php echo e(route('admin.users.index')); ?>"
                   class="sidebar-link group flex items-center rounded-lg text-white/80 py-3 <?php echo e(request()->routeIs('admin.users.*') ? 'active' : ''); ?>"
                   :class="sidebarOpen ? 'space-x-3 px-4 justify-start' : 'px-3 justify-center'">
                    <svg class="w-6 h-6 text-white/70 group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('admin.categories.index')); ?>"
                   class="sidebar-link group flex items-center rounded-lg text-white/80 py-3 <?php echo e(request()->routeIs('admin.categories.*') ? 'active' : ''); ?>"
                   :class="sidebarOpen ? 'space-x-3 px-4 justify-start' : 'px-3 justify-center'">
                    <svg class="w-6 h-6 text-white/70 group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('admin.jobs.index')); ?>"
                   class="sidebar-link group flex items-center rounded-lg text-white/80 py-3 <?php echo e(request()->routeIs('admin.jobs.*') ? 'active' : ''); ?>"
                   :class="sidebarOpen ? 'space-x-3 px-4 justify-start' : 'px-3 justify-center'">
                    <svg class="w-6 h-6 text-white/70 group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('admin.programs.index')); ?>"
                   class="sidebar-link group flex items-center rounded-lg text-white/80 py-3 <?php echo e(request()->routeIs('admin.programs.*') ? 'active' : ''); ?>"
                   :class="sidebarOpen ? 'space-x-3 px-4 justify-start' : 'px-3 justify-center'">
                    <svg class="w-6 h-6 text-white/70 group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('admin.applications.index')); ?>"
                   class="sidebar-link group flex items-center rounded-lg text-white/80 py-3 <?php echo e(request()->routeIs('admin.applications.*') ? 'active' : ''); ?>"
                   :class="sidebarOpen ? 'space-x-3 px-4 justify-start' : 'px-3 justify-center'">
                    <svg class="w-6 h-6 text-white/70 group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('admin.blogs.index')); ?>"
                   class="sidebar-link group flex items-center rounded-lg text-white/80 py-3 <?php echo e(request()->routeIs('admin.blogs.*') ? 'active' : ''); ?>"
                   :class="sidebarOpen ? 'space-x-3 px-4 justify-start' : 'px-3 justify-center'">
                    <svg class="w-6 h-6 text-white/70 group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="<?php echo e(route('admin.blog-categories.index')); ?>"
                   class="sidebar-link group flex items-center rounded-lg text-white/80 py-3 <?php echo e(request()->routeIs('admin.blog-categories.*') ? 'active' : ''); ?>"
                   :class="sidebarOpen ? 'space-x-3 px-4 justify-start' : 'px-3 justify-center'">
                    <svg class="w-6 h-6 text-white/70 group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z"></path>
                    </svg>
                ...
                <a href="<?php echo e(route('admin.settings.index')); ?>"
                   class="sidebar-link group flex items-center rounded-lg text-white/80 py-3 <?php echo e(request()->routeIs('admin.settings.*') ? 'active' : ''); ?>"
                   :class="sidebarOpen ? 'space-x-3 px-4 justify-start' : 'px-3 justify-center'">
                    <svg class="w-6 h-6 text-white/70 group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div :class="sidebarOpen ? 'ml-64' : 'ml-20'" class="flex-1 transition-all duration-300 bg-slate-50 min-h-screen">
            ...
            <header class="brand-gradient text-white shadow-lg sticky top-0 z-20">
                <div class="px-6 py-4 flex items-center justify-between">
                    <h1 class="text-2xl font-semibold"><?php echo $__env->yieldContent('page-title', 'Dashboard'); ?></h1>
...
<?php /**PATH /var/www/placemenet/resources/views/layouts/admin.blade.php ENDPATH**/ ?>