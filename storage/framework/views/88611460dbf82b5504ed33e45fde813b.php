...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-2xl mx-auto">
            ...
            <div class="flex items-start">
                ...
                <div class="flex-1">
                    <p class="text-sm text-blue-800">
                        This category has <strong><?php echo e($blogCategory->blogs_count); ?> <?php echo e(Str::plural('blog', $blogCategory->blogs_count)); ?></strong>.
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($blogCategory->blogs_count > 0): ?>
                            Changing the name will update the slug, which may affect URLs.
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </p>
                </div>
            </div>
        ...
        <form action="<?php echo e(route('admin.blog-categories.update', $blogCategory)); ?>" method="POST" class="space-y-6">
            <?php echo csrf_field(); ?>
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 space-y-6">
                ...
                <div>
                    ...
                    <input type="text"
                           name="name"
                           id="name"
                           value="<?php echo e(old('name', $blogCategory->name)); ?>"
...
$message = $__bag->first($__errorArgs[0]); ?>
                    ...
                    <?php else: ?>
                        <p class="mt-1 text-xs text-gray-500">
                            Current slug: <code class="bg-gray-100 px-2 py-0.5 rounded"><?php echo e($blogCategory->slug); ?></code>
                        </p>
                    <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
...
unset($__errorArgs, $__bag); ?>"
                              placeholder="Brief description of this category"><?php echo e(old('description', $blogCategory->description)); ?></textarea>
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div>
                    ...
                    <input type="text"
                           name="icon"
                           id="icon"
                           value="<?php echo e(old('icon', $blogCategory->icon)); ?>"
                           maxlength="2"
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div>
                    ...
                    <input type="number"
                           name="sort_order"
                           id="sort_order"
                           value="<?php echo e(old('sort_order', $blogCategory->sort_order)); ?>"
                           min="0"
...
unset($__errorArgs, $__bag); ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                ...
                <div>
                    ...
                    <p class="mt-1 ml-7 text-xs text-gray-500">
                        Only active categories are visible to content creators
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($blogCategory->blogs_count > 0 && $blogCategory->is_active): ?>
                            <span class="text-orange-600">(Deactivating will hide <?php echo e($blogCategory->blogs_count); ?> blogs)</span>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </p>
                </div>
            </div>
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <?php else: ?>
                        <button type="button"
                                disabled
                                title="Cannot delete category with blogs"
                                class="px-6 py-2 bg-gray-300 text-gray-500 font-medium rounded-lg cursor-not-allowed">
                            Delete Category
                        </button>
                        <p class="text-xs text-gray-500 mt-1">Cannot delete - has <?php echo e($blogCategory->blogs_count); ?> blogs</p>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                </div>
        ...
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($blogCategory->blogs_count == 0): ?>
            <form id="delete-form"
                  action="<?php echo e(route('admin.blog-categories.destroy', $blogCategory)); ?>"
                  method="POST"
                  class="hidden">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/placemenet/resources/views/admin/blog-categories/edit.blade.php ENDPATH**/ ?>