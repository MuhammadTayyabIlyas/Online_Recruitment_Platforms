...
<?php $__env->startSection('meta_description', 'Search verified roles from top employers. Filter by title, location, type, and salary. Quick links to study programs and visa paths to keep your options open.'); ?>
            ...
            <div class="grid md:grid-cols-2 gap-10 items-center">
                <div>
                    ...
                    <div class="flex flex-col sm:flex-row gap-3">
                        ...
                        <a href="<?php echo e(route('register')); ?>" class="inline-flex items-center justify-center gap-2 border border-blue-200 text-blue-700 hover:bg-blue-50 font-semibold px-6 py-3 rounded-lg transition">
                            Upload your resume
                            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
$key ??= \Livewire\Features\SupportCompiledWireKeys\SupportCompiledWireKeys::generateKey('lw-1936571329-0', null);
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/placemenet/resources/views/jobs/index.blade.php ENDPATH**/ ?>