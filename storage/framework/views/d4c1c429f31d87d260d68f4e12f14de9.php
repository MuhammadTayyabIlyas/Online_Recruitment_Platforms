                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            <p style="margin: 0 0 20px; color: #1f2937; font-size: 16px; line-height: 1.6;">
                                Dear <strong><?php echo e($application->user->name); ?></strong>,
                            </p>

                            <p style="margin: 0 0 25px; color: #4b5563; font-size: 16px; line-height: 1.7;">
                                Thank you for taking the time to apply for the position of <strong><?php echo e($application->job->title); ?></strong> at <strong><?php echo e($application->job->company->company_name); ?></strong> and for your interest in joining our team.
                            </p>
                                ...
                                <tr>
                                    <td style="padding: 25px;">
                                        ...
                                        <div style="margin-bottom: 12px;">
                                            ...
                                            <span style="color: #374151; font-size: 14px;"><?php echo e($application->job->company->company_name); ?></span>
                                        </div>

                                        <div>
                                            <span style="color: #6b7280; font-size: 14px; font-weight: 600;">📅 Applied:</span>
                                            <span style="color: #374151; font-size: 14px;"><?php echo e($application->created_at->format('F d, Y')); ?></span>
                                        </div>
                                    </td>
                                </tr>
                            </table>
...
<?php /**PATH /var/www/placemenet/resources/views/emails/application-status/rejected.blade.php ENDPATH**/ ?>