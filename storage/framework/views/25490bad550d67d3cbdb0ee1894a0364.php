...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$hasCompany): ?>
            ...
            <div class="flex">
                ...
                <div class="ml-3">
                    <p class="text-sm text-yellow-700">
                        Please <a href="<?php echo e(route('employer.company.create')); ?>" class="font-medium underline">create your company profile</a> first before requesting access to packages.
                    </p>
                </div>
            </div>
        </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__empty_1 = true; $__currentLoopData = $packages->take(3); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $package): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="bg-white rounded-2xl shadow-xl border-2 <?php echo e($loop->iteration === 2 ? 'border-indigo-500 transform scale-105' : 'border-gray-200'); ?> overflow-hidden">
                ...
                <div class="p-8">
                    <div class="mb-4">
                        <h3 class="text-2xl font-bold text-gray-900 mb-1"><?php echo e($package->name); ?></h3>
                        <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($package->slug == 'professional'): ?>
                    ...
                    <div class="mb-6">
                        <span class="text-5xl font-bold text-gray-900">€<?php echo e(number_format($package->price, 0)); ?></span>
                    ...
                    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($package->description): ?>
                        <p class="text-gray-600 mb-6 text-sm leading-relaxed"><?php echo e($package->description); ?></p>
                    <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    ...
                    <div class="mt-8">
                        ...
                        <?php else: ?>
                            <a href="<?php echo e(route('employer.subscription')); ?>" class="w-full bg-gradient-to-r from-indigo-600 to-purple-600 text-white py-3 px-4 rounded-lg font-semibold hover:from-indigo-700 hover:to-purple-700 transition-all transform hover:scale-105 shadow-lg block text-center">
                                Contact Sales
                            </a>
                        <?php endif; ?><?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if ENDBLOCK]><![endif]--><?php endif; ?>
                    </div>
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(!$isApproved && $hasCompany): ?>
        <div class="bg-gradient-to-r from-indigo-50 to-purple-50 rounded-2xl shadow-lg p-8 border border-indigo-200">
            <div class="text-center">
                ...
                <div class="flex flex-col sm:flex-row gap-4 justify-center items-center">
                    <a href="mailto:admin@placemenet.net?subject=Package Subscription Request - <?php echo e(auth()->user()->company->company_name ?? 'Company'); ?>"
...
<?php echo $__env->make('layouts.employer', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/placemenet/resources/views/employer/packages.blade.php ENDPATH**/ ?>