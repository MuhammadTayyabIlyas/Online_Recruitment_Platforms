<?php $__env->startSection('title', 'Document Upload'); ?>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function loadStatus() {
        fetch('<?php echo e(route("jobseeker.documents.status")); ?>')
    ...
    function uploadFile(file, docNumber) {
        ...
        fetch('<?php echo e(route("jobseeker.documents.upload")); ?>', {
            method: 'POST',
            headers: {
        ...
        documentsList.innerHTML = currentDocuments.map(doc => `
            <div class="flex items-center justify-between p-4 bg-gray-50 rounded-lg border border-gray-200">
                ...
                <div class="flex items-center space-x-2">
                    <a href="<?php echo e(url('jobseeker/documents')); ?>/${doc.id}/download"
    ...
    window.deleteDocument = function(documentId) {
        ...
        fetch(`<?php echo e(url('jobseeker/documents')); ?>/${documentId}`, {
            method: 'DELETE',
            headers: {
                'X-CSRF-TOKEN': csrfToken,
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/placemenet/resources/views/jobseeker/documents/index.blade.php ENDPATH**/ ?>