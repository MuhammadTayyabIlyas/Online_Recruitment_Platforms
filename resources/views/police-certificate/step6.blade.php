...
<div class="space-y-6" x-data="{
    ...
    <div class="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-xl p-6">
        <div class="flex items-start">
            ...
            <div class="ml-4">
                <h3 class="text-lg font-bold text-blue-900 mb-2">Authorization Letter</h3>
                <p class="text-blue-700">
                    This letter authorizes <strong>PLACEMENT UK LIMITED</strong> (Company No. 04699796) to apply to ACRO for a UK Police Certificate on your behalf. You can <strong>sign directly on your screen</strong> (fastest!) or download the letter, print, sign by hand, and upload it.
                </p>
            </div>
        </div>
    </div>
    ...
    <div class="flex rounded-lg border border-gray-200 overflow-hidden">
        <button type="button"
                ...
                :class="activeTab === 'sign-online' ? 'bg-blue-600 text-white' : 'bg-white text-gray-700 hover:bg-gray-50'"
        ...
        <button type="button"
                ...
                :class="activeTab === 'upload' ? 'bg-blue-600 text-white' : 'bg-white text-gray-700 hover:bg-gray-50'"
    ...
    <div x-show="activeTab === 'sign-online'" x-cloak class="space-y-6">
        ...
        <div class="bg-gray-50 border border-gray-200 rounded-xl p-6">
            ...
            <div class="bg-white border border-gray-300 rounded-lg p-6 text-sm text-gray-700 leading-relaxed">
                <p class="mb-4">
                    I, <strong>{{ $application->full_name ?? '___' }}</strong>, holder of Pakistani passport number
                    <strong>{{ $application->passport_number ?? '___' }}</strong>, CNIC/NICOP number
                    <strong>{{ $application->cnic_nicop_number ?? '___' }}</strong>, hereby authorize
                    <strong>PLACEMENT UK LIMITED</strong> (Company No. 04699796) to act on my behalf for the purpose of
                    applying for and obtaining my UK Police Certificate (ACRO Criminal Records Certificate) from the
        ...
        <div class="bg-white border-2 border-gray-200 rounded-xl p-6">
            ...
            <div class="mb-4">
                ...
                <input type="text" name="signature_place" id="signature_place"
                       value="{{ old('signature_place', $application->signature_place ?? ($application->spain_city ? $application->spain_city . ', Spain' : '')) }}"
                       class="w-full md:w-1/2 px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 @error('signature_place') border-red-500 @enderror"
            ...
            <div x-data="signaturePadComponent()" x-init="initSignaturePad()">
                ...
                <div class="border-2 border-gray-300 rounded-lg bg-white overflow-hidden" :class="isEmpty ? '' : 'border-blue-400'">
        ...
        <div class="bg-blue-50 border border-blue-200 rounded-lg p-4">
            <p class="text-sm text-blue-800">
                <strong>What happens next:</strong> We'll generate your authorization letter with all your pre-filled details (name, passport, CNIC, address) plus your signature, date, and signing place. The completed PDF is stored with your application.
            </p>
        </div>
    </div>
            ...
            <div class="space-y-6">
                ...
                <div class="flex items-start">
                    ...
                    <div class="ml-4 flex-1">
                        ...
                        <a href="{{ route('police-certificate.download-authorization-letter') }}"
                           class="inline-flex items-center px-5 py-3 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 transition shadow-sm min-h-[48px]">
                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <!-- Divider -->
                <div class="border-l-2 border-blue-200 ml-5 h-4"></div>
