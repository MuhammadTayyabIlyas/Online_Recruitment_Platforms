...
<!-- Disclaimer Modal -->
<div x-data="{
    showDisclaimer: {{ session('pcc_disclaimer_accepted') ? 'false' : 'true' }},
    accepted: false
}" x-cloak>
    <!-- Modal Backdrop -->
    <div x-show="showDisclaimer"
        ...
        <div class="flex min-h-screen items-center justify-center p-4">
            ...
            <div x-show="showDisclaimer"
                ...
                <!-- Header -->
                <div class="bg-gradient-to-r from-blue-600 to-indigo-700 px-6 py-5 rounded-t-2xl">
                    <div class="flex items-center">
                        ...
                        <h3 class="ml-4 text-xl font-bold text-white" id="disclaimer-title">
                            PCC / Police & Criminal Record Certificate Disclaimer
                        </h3>
                    </div>
                </div>
                ...
                <div class="bg-gray-50 px-6 py-4 rounded-b-2xl border-t border-gray-200">
                    <div class="flex flex-col sm:flex-row items-center gap-4">
                        ...
                        <label class="flex items-start cursor-pointer flex-1">
                            <input type="checkbox" x-model="accepted" class="mt-1 h-4 w-4 text-blue-600 border-gray-300 rounded focus:ring-blue-500">
                        ...
                        <div class="flex gap-3">
                            ...
                            <button type="button"
                                    @click="if(accepted) {
                                        fetch('{{ route('police-certificate.accept-disclaimer') }}', {
                                            method: 'POST',
                                            headers: {
                                    ...
                                    :disabled="!accepted"
                                    :class="accepted ? 'bg-blue-600 hover:bg-blue-700 cursor-pointer' : 'bg-gray-300 cursor-not-allowed'"
