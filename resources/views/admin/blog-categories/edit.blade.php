            ...
            <div class="flex items-start">
                ...
                <div class="flex-1">
                    <p class="text-sm text-blue-800">
                        This category has <strong>{{ $blogCategory->blogs_count }} {{ Str::plural('blog', $blogCategory->blogs_count) }}</strong>.
            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 space-y-6">
                ...
                <div>
                    ...
                    @else
                        <p class="mt-1 text-xs text-gray-500">
                            Current slug: <code class="bg-gray-100 px-2 py-0.5 rounded">{{ $blogCategory->slug }}</code>
                        </p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <p class="mt-1 ml-7 text-xs text-gray-500">
                        ...
                        @if($blogCategory->blogs_count > 0 && $blogCategory->is_active)
                            <span class="text-orange-600">(Deactivating will hide {{ $blogCategory->blogs_count }} blogs)</span>
                        @endif
                    </p>
                </div>
            </div>
            ...
            <div class="flex items-center justify-between">
                <div>
                    ...
                    @else
                        ...
                        <p class="text-xs text-gray-500 mt-1">Cannot delete - has {{ $blogCategory->blogs_count }} blogs</p>
                    @endif
                </div>
