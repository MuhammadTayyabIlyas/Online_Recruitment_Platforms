...
<div class="container mx-auto px-4 py-8">
    <div class="mb-6">
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('content-creator.blogs.show', $blog) }}" class="inline-flex items-center px-4 py-2 bg-gray-600 hover:bg-gray-700 text-white rounded-lg transition">
        ...
        <div class="mb-6 bg-red-50 border border-red-200 rounded-lg p-4">
            <div class="flex items-start">
                ...
                <div class="flex-1">
                    ...
                    <p class="text-sm text-red-700 whitespace-pre-line">{{ $blog->admin_feedback }}</p>
                </div>
            </div>
        </div>
    @endif

    <form action="{{ route('content-creator.blogs.update', $blog) }}" method="POST" enctype="multipart/form-data" id="blogForm" class="space-y-6">
        @csrf
        @method('PUT')
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <textarea name="excerpt"
                                      ...
                                      placeholder="Write a brief summary that will appear in blog listings and search results">{{ old('excerpt', $blog->excerpt) }}</textarea>
            ...
            <div class="lg:col-span-1 space-y-6">
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <span class="text-sm font-medium text-gray-900">{{ $blog->created_at->format('M d, Y') }}</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-gradient-to-br from-blue-50 to-purple-50 rounded-lg shadow-sm border border-blue-200 p-6">
                    ...
                    <div class="space-y-3">
                        ...
                        <a href="{{ route('content-creator.blogs.show', $blog) }}"
