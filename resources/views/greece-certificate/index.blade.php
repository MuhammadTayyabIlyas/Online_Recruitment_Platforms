...
<div class="min-h-screen bg-gradient-to-br from-amber-50 to-yellow-50">
    ...
    <div class="relative overflow-hidden">
        <div class="absolute inset-0 bg-gradient-to-r from-amber-500 to-yellow-600"></div>
        ...
        <div class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24">
            <div class="text-center">
                ...
                <h1 class="text-4xl md:text-5xl font-bold text-white mb-6">
                    ...
                    <span class="text-amber-200">Certificate Application</span>
                </h1>

                <p class="text-xl text-amber-100 max-w-3xl mx-auto mb-8">
                    Get your Greek Penal Record Certificate for employment, immigration, visa applications, and more. We handle the entire process for you.
                </p>

                <div class="flex flex-col sm:flex-row gap-4 justify-center">
                    <a href="{{ route('greece-certificate.step', ['step' => 1]) }}"
                       class="inline-flex items-center justify-center px-8 py-4 bg-white text-amber-700 font-bold rounded-xl hover:bg-amber-50 transition shadow-xl hover:shadow-2xl transform hover:-translate-y-1">
    ...
    <div class="bg-white py-16">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                ...
                <div class="bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl p-8 border-2 border-gray-200">
                    <div class="text-center">
                        ...
                        <div class="text-4xl font-bold text-gray-900 mb-6">
                            75 <span class="text-xl text-gray-600">EUR</span>
                        </div>
                ...
                <!-- Urgent Service -->
                <div class="bg-gradient-to-br from-amber-500 to-yellow-600 rounded-2xl p-8 text-white relative overflow-hidden">
                    ...
                    <div class="text-center">
                        ...
                        <p class="text-amber-100 mb-6">Processing in 2-3 working days</p>
                        <div class="text-4xl font-bold mb-6">
                            120 <span class="text-xl text-amber-200">EUR</span>
                        </div>
                        <ul class="text-left space-y-3 mb-8">
                            <li class="flex items-center">
                                <svg class="w-5 h-5 text-amber-200 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"/>
                                </svg>
                                Priority processing
                            </li>
    ...
    <div id="how-it-works" class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div class="grid md:grid-cols-5 gap-6">
            <div class="text-center">
                <div class="w-14 h-14 bg-amber-600 text-white rounded-full flex items-center justify-center text-xl font-bold mx-auto mb-4">1</div>
            ...
            <div class="text-center">
                <div class="w-14 h-14 bg-amber-600 text-white rounded-full flex items-center justify-center text-xl font-bold mx-auto mb-4">2</div>
            ...
            <div class="text-center">
                <div class="w-14 h-14 bg-amber-600 text-white rounded-full flex items-center justify-center text-xl font-bold mx-auto mb-4">3</div>
            ...
            <div class="text-center">
                <div class="w-14 h-14 bg-amber-600 text-white rounded-full flex items-center justify-center text-xl font-bold mx-auto mb-4">4</div>
                <h3 class="font-bold text-gray-900 mb-2">We Process</h3>
                <p class="text-gray-600 text-sm">We submit to Greek authorities</p>
            </div>
            <div class="text-center">
                <div class="w-14 h-14 bg-amber-600 text-white rounded-full flex items-center justify-center text-xl font-bold mx-auto mb-4">5</div>
    ...
    <!-- CTA Section -->
    <div class="bg-gradient-to-r from-amber-500 to-yellow-600 py-16">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 class="text-3xl font-bold text-white mb-4">Ready to Apply?</h2>
            <p class="text-amber-100 text-lg mb-8">Start your application now and get your Greece Penal Record Certificate</p>
            <a href="{{ route('greece-certificate.step', ['step' => 1]) }}"
               class="inline-flex items-center px-8 py-4 bg-white text-amber-700 font-bold rounded-xl hover:bg-amber-50 transition shadow-xl">
