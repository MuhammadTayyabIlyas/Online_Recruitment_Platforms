        ...
        <div class="bg-white shadow rounded-lg p-6">
            ...
            <div class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div id="province-wrapper" class="{{ empty($selectedCountryIso) ? 'hidden' : '' }}">
                        ...
                        <input type="hidden" name="province_state_code" id="province_state_code" value="{{ old('province_state_code', $user->profile?->province_state_code) }}">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const countriesProvinces = @json(config('countries_provinces'));
