...
<head>
    ...
    <title>Appointment Confirmed - Placemenet</title>
</head>
                ...
                <table role="presentation" style="max-width: 650px; margin: 0 auto; background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            ...
                            <!-- Confirmation Box -->
                            <table role="presentation" style="width: 100%; border-collapse: collapse; margin: 0 0 30px; background: #eff6ff; border-radius: 12px; border: 2px solid #3b82f6;">
                                <tr>
                                    <td style="padding: 25px; text-align: center;">
                                        <p style="margin: 0 0 5px; color: #6b7280; font-size: 14px;">Status</p>
                                        <h2 style="margin: 0; color: #1e40af; font-size: 28px; font-weight: 700;">
                                            Confirmed
                                        </h2>
                                    </td>
                                </tr>
                            ...
                            <div style="text-align: center; margin: 0 0 30px;">
                                ...
                                <a href="{{ route('appointments.cancel', $appointment->booking_reference) }}" style="display: inline-block; padding: 12px 30px; background-color: #fee2e2; color: #991b1b; font-size: 14px; font-weight: 600; text-decoration: none; border-radius: 8px;">
                                    Cancel Appointment
                                </a>
                            </div>
