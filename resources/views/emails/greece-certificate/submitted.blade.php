...
<head>
    ...
    <title>Application Received - Greece Penal Record Certificate</title>
</head>
        ...
        <tr>
            <td style="padding: 40px 20px;">
                <table role="presentation" style="max-width: 650px; margin: 0 auto; background-color: #ffffff; border-radius: 16px; overflow: hidden; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1);">
                    ...
                    <!-- Header -->
                    <tr>
                        <td style="background: linear-gradient(135deg, #b45309 0%, #d97706 100%); padding: 40px 30px; text-align: center;">
                            <h1 style="margin: 0; color: #ffffff; font-size: 26px; font-weight: 700;">
                                Greece Penal Record Certificate
                            </h1>
                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            ...
                            <!-- Application Summary -->
                            <table role="presentation" style="width: 100%; border-collapse: collapse; margin: 0 0 30px; background: #fffbeb; border-radius: 12px; border: 2px solid #fcd34d;">
                                <tr>
                                    <td style="padding: 20px;">
                                        ...
                                        <table style="width: 100%; font-size: 14px;">
                                            <tr>
                                                ...
                                                <td style="padding: 5px 0; color: #78350f; font-weight: 600;">{{ $application->application_reference }}</td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 5px 0; color: #64748b;">Applicant:</td>
                                                <td style="padding: 5px 0; color: #78350f; font-weight: 600;">{{ $application->first_name }} {{ $application->last_name }}</td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 5px 0; color: #64748b;">Service Type:</td>
                                                <td style="padding: 5px 0; color: #78350f; font-weight: 600;">{{ ucfirst($application->service_type) }} Service</td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 5px 0; color: #64748b;">Amount Due:</td>
                                                <td style="padding: 5px 0; color: #78350f; font-weight: 600; font-size: 16px;">&euro;{{ number_format($application->payment_amount, 2) }}</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                                    ...
                                    <td style="padding: 20px;">
                                        ...
                                        <table style="width: 100%; font-size: 14px;">
                                            ...
                                            <tr>
                                                ...
                                                <td style="padding: 4px 0; color: #b45309; font-weight: 700; font-family: monospace;">{{ $application->application_reference }}</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                            ...
                            <table role="presentation" style="width: 100%; border-collapse: collapse; margin: 0 0 25px;">
                                <tr>
                                    <td style="text-align: center; padding: 10px 0;">
                                        <a href="{{ route('greece-certificate.receipt.show', ['reference' => $application->application_reference]) }}"
                                           style="display: inline-block; background: linear-gradient(135deg, #b45309 0%, #d97706 100%); color: #ffffff; text-decoration: none; padding: 16px 40px; border-radius: 12px; font-weight: 700; font-size: 16px; box-shadow: 0 4px 12px rgba(180, 83, 9, 0.4);">
                            ...
                            <p style="margin: 0 0 20px; color: #6b7280; font-size: 15px; line-height: 1.6;">
                                If you require any clarification, feel free to reply to this email or contact us at <a href="mailto:info@placemenet.com" style="color: #d97706; text-decoration: none; font-weight: 600;">info@placemenet.com</a>.
                            </p>

                            <p style="margin: 0; color: #1f2937; font-size: 15px; line-height: 1.8;">
                                Kind regards,<br>
                                <strong style="color: #b45309;">Placemenet Team</strong><br>
                                <span style="color: #6b7280; font-size: 14px;">
                                    Email: <a href="mailto:info@placemenet.com" style="color: #d97706; text-decoration: none;">info@placemenet.com</a><br>
                                    Website: <a href="https://www.placemenet.com" style="color: #d97706; text-decoration: none;">www.placemenet.com</a>
                                </span>
                            </p>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td style="background-color: #f9fafb; padding: 30px; text-align: center; border-top: 1px solid #e5e7eb;">
                            <p style="margin: 0 0 10px; color: #6b7280; font-size: 14px;">
                                Need help? Contact us at <a href="mailto:info@placemenet.com" style="color: #d97706; text-decoration: none; font-weight: 600;">info@placemenet.com</a>
                            </p>
