                    ...
                    <tr>
                        <td style="padding: 40px 30px;">
                            ...
                            <p style="margin: 0 0 25px; color: #4b5563; font-size: 16px; line-height: 1.7;">
                                This is to inform you that your application status for <strong>{{ $application->job->title }}</strong> at <strong>{{ $application->job->company->company_name }}</strong> has been updated.
                            </p>
                                ...
                                <tr>
                                    <td style="padding: 25px;">
                                        ...
                                        <div style="margin-bottom: 12px;">
                                            ...
                                            <span style="color: #0c4a6e; font-size: 14px;">{{ $application->job->company->company_name }}</span>
                                        </div>
                                        ...
                                        <div>
                                            ...
                                            <span style="background-color: #3b82f6; color: #ffffff; padding: 4px 12px; border-radius: 12px; font-size: 13px; font-weight: 700; text-transform: uppercase;">{{ $application->status }}</span>
                                        </div>
                                    </td>
                                </tr>
                            </table>
