            ...
            <div class="flex items-center justify-between p-4 border-b border-white/10">
                <a href="{{ route('home') }}" class="flex items-center gap-3" x-show="sidebarOpen">
                    <div class="h-12 w-12 rounded-2xl bg-white/10 backdrop-blur-lg flex items-center justify-center shadow-lg">
                        <img src="{{ asset('assets/images/logo.jpg') }}" alt="PlaceMeNet Employer" class="h-8 w-auto object-contain drop-shadow">
                    </div>
                    <div class="leading-tight">
                        <p class="font-semibold tracking-wide text-white">PlaceMeNet</p>
                        <p class="text-xs text-white/70 uppercase tracking-[0.2em]">
                            {{ auth()->user()->hasRole('educational_institution') ? 'Institution Hub' : 'Employer Hub' }}
                        </p>
                    </div>
                </a>
            ...
            <nav class="p-4 space-y-2 overflow-y-auto h-[calc(100vh-160px)] text-white">
                @if(auth()->user()->hasRole('educational_institution'))
                    ...
                    <a href="{{ route('institution.dashboard') }}"
                       class="sidebar-link group flex items-center rounded-lg text-white/80 py-3 {{ request()->routeIs('institution.dashboard') ? 'active' : '' }}"
                    ...
                    <a href="{{ route('institution.programs.index') }}"
                       class="sidebar-link group flex items-center rounded-lg text-white/80 py-3 {{ request()->routeIs('institution.programs.*') ? 'active' : '' }}"
                       :class="sidebarOpen ? 'space-x-3 px-4 justify-start' : 'space-x-0 px-2 justify-center'">
                        <svg class="w-6 h-6 text-white/70 group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('institution.programs.create') }}"
                       class="sidebar-link group flex items-center rounded-lg text-white/80 py-3 {{ request()->routeIs('institution.programs.create') ? 'active' : '' }}"
                       :class="sidebarOpen ? 'space-x-3 px-4 justify-start' : 'space-x-0 px-2 justify-center'">
                        <svg class="w-6 h-6 text-white/70 group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('institution.applications.index') }}"
                       class="sidebar-link group flex items-center rounded-lg text-white/80 py-3 {{ request()->routeIs('institution.applications.*') ? 'active' : '' }}"
                       :class="sidebarOpen ? 'space-x-3 px-4 justify-start' : 'space-x-0 px-2 justify-center'">
                        <svg class="w-6 h-6 text-white/70 group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    @if(auth()->user()->company)
                        <a href="{{ route('employer.company.show') }}"
                           class="sidebar-link group flex items-center rounded-lg text-white/80 py-3 {{ request()->routeIs('employer.company.*') ? 'active' : '' }}"
                           :class="sidebarOpen ? 'space-x-3 px-4 justify-start' : 'space-x-0 px-2 justify-center'">
                            <svg class="w-6 h-6 text-white/70 group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                @else
                    <a href="{{ route('employer.dashboard') }}"
                       class="sidebar-link group flex items-center rounded-lg text-white/80 py-3 {{ request()->routeIs('employer.dashboard') ? 'active' : '' }}"
                       :class="sidebarOpen ? 'space-x-3 px-4 justify-start' : 'space-x-0 px-2 justify-center'">
                        <svg class="w-6 h-6 text-white/70 group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('employer.jobs.create') }}"
                       class="sidebar-link group flex items-center rounded-lg text-white/80 py-3 {{ request()->routeIs('employer.jobs.create') ? 'active' : '' }}"
                       :class="sidebarOpen ? 'space-x-3 px-4 justify-start' : 'space-x-0 px-2 justify-center'">
                        <svg class="w-6 h-6 text-white/70 group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path>
                        </svg>
                    ...
                    <a href="{{ route('employer.jobs.index') }}"
                       class="sidebar-link group flex items-center rounded-lg text-white/80 py-3 {{ request()->routeIs('employer.jobs.index') || request()->routeIs('employer.jobs.edit') || request()->routeIs('employer.jobs.show') ? 'active' : '' }}"
                       :class="sidebarOpen ? 'space-x-3 px-4 justify-start' : 'space-x-0 px-2 justify-center'">
                        <svg class="w-6 h-6 text-white/70 group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('employer.applicants.index') }}"
                       class="sidebar-link group flex items-center rounded-lg text-white/80 py-3 {{ request()->routeIs('employer.applicants.*') ? 'active' : '' }}"
                       :class="sidebarOpen ? 'space-x-3 px-4 justify-start' : 'space-x-0 px-2 justify-center'">
                        <svg class="w-6 h-6 text-white/70 group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    @if(Route::has('employer.cv.index'))
                    <a href="{{ route('employer.cv.index') }}"
                       class="sidebar-link group flex items-center rounded-lg text-white/80 py-3 {{ request()->routeIs('employer.cv.*') ? 'active' : '' }}"
                       :class="sidebarOpen ? 'space-x-3 px-4 justify-start' : 'space-x-0 px-2 justify-center'">
                        <svg class="w-6 h-6 text-white/70 group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                @if(!auth()->user()->hasRole('educational_institution'))
                    @if(auth()->user()->company)
                        <a href="{{ route('employer.company.show') }}"
                           class="sidebar-link group flex items-center rounded-lg text-white/80 py-3 {{ request()->routeIs('employer.company.show') ? 'active' : '' }}"
                           :class="sidebarOpen ? 'space-x-3 px-4 justify-start' : 'space-x-0 px-2 justify-center'">
                            <svg class="w-6 h-6 text-white/70 group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path>
                            </svg>
                        ...
                        <a href="{{ route('employer.company.edit') }}"
                           class="sidebar-link group flex items-center rounded-lg text-white/80 py-3 {{ request()->routeIs('employer.company.edit') ? 'active' : '' }}"
                           :class="sidebarOpen ? 'space-x-3 px-4 justify-start' : 'space-x-0 px-2 justify-center'">
                            <svg class="w-6 h-6 text-white/70 group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    @else
                        <a href="{{ route('employer.company.create') }}"
                           class="sidebar-link group flex items-center rounded-lg text-white/80 py-3 {{ request()->routeIs('employer.company.create') ? 'active' : '' }}"
                           :class="sidebarOpen ? 'space-x-3 px-4 justify-start' : 'space-x-0 px-2 justify-center'">
                            <svg class="w-6 h-6 text-white/70 group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4v16m8-8H4"></path>
                            </svg>
                ...
                @if(!auth()->user()->hasRole('educational_institution'))
                    <a href="{{ route('employer.subscription') }}"
                       class="sidebar-link group flex items-center rounded-lg text-white/80 py-3 {{ request()->routeIs('employer.subscription') ? 'active' : '' }}"
                       :class="sidebarOpen ? 'space-x-3 px-4 justify-start' : 'space-x-0 px-2 justify-center'">
                        <svg class="w-6 h-6 text-white/70 group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <a href="{{ route('employer.packages') }}"
                       class="sidebar-link group flex items-center rounded-lg text-white/80 py-3 {{ request()->routeIs('employer.packages') ? 'active' : '' }}"
                       :class="sidebarOpen ? 'space-x-3 px-4 justify-start' : 'space-x-0 px-2 justify-center'">
                        <svg class="w-6 h-6 text-white/70 group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <header class="brand-gradient text-white shadow-lg sticky top-0 z-10">
                <div class="px-6 py-4 flex items-center justify-between">
                    <div class="flex items-center space-x-3">
                        ...
                        <h1 class="text-2xl font-semibold">@yield('page-title', auth()->user()->hasRole('educational_institution') ? 'Institution Dashboard' : 'Employer Dashboard')</h1>
                    </div>
