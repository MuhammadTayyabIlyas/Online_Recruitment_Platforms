            ...
            <nav class="flex-1 overflow-y-auto p-4 space-y-2 text-white">
                ...
                <a href="{{ route('admin.police-certificates.index') }}"
                   ...
                   :class="sidebarOpen ? 'space-x-3 px-4 justify-start' : 'px-3 justify-center'">
                    ...
                    <span x-show="sidebarOpen">UK Police Certificates</span>
                </a>

                <!-- Portugal Certificates -->
                <a href="{{ route('admin.portugal-certificates.index') }}"
                   class="sidebar-link group flex items-center rounded-lg text-white/80 py-3 {{ request()->routeIs('admin.portugal-certificates.*') || request()->routeIs('admin.portugal-certificate.*') ? 'active' : '' }}"
                   :class="sidebarOpen ? 'space-x-3 px-4 justify-start' : 'px-3 justify-center'">
                    <svg class="w-6 h-6 text-white/70 group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path>
                    </svg>
                    <span x-show="sidebarOpen">Portugal Certificates</span>
                </a>

                <!-- Greece Certificates -->
                <a href="{{ route('admin.greece-certificates.index') }}"
                   class="sidebar-link group flex items-center rounded-lg text-white/80 py-3 {{ request()->routeIs('admin.greece-certificates.*') || request()->routeIs('admin.greece-certificate.*') ? 'active' : '' }}"
                   :class="sidebarOpen ? 'space-x-3 px-4 justify-start' : 'px-3 justify-center'">
                    <svg class="w-6 h-6 text-white/70 group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
