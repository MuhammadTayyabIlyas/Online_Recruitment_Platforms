...
<div class="space-y-6">
    ...
    <div>
        ...
        <input type="text" name="current_address_line1" id="current_address_line1"
               ...
               class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 @error('current_address_line1') border-red-500 @enderror"
    ...
    <div class="grid md:grid-cols-2 gap-4">
        <div>
            ...
            <input type="text" name="current_city" id="current_city"
                   ...
                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 @error('current_city') border-red-500 @enderror"
                   required>
            @error('current_city')
                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
            @enderror
        ...
        <div>
            ...
            <input type="text" name="current_postal_code" id="current_postal_code"
                   ...
                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 @error('current_postal_code') border-red-500 @enderror"
    ...
    <div>
        ...
        <input type="text" name="current_country" id="current_country"
               value="{{ old('current_country', $application->current_country ?? 'Portugal') }}"
               class="w-full md:w-1/2 px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 @error('current_country') border-red-500 @enderror"
               required>
