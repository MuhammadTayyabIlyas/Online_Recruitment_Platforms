...
@section('title', 'Application Submitted - Portugal Criminal Record Certificate')
    ...
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-green-600 to-emerald-700 px-8 py-10 text-center">
                ...
                <p class="text-green-100">Your Portugal Criminal Record Certificate application has been received.</p>
            </div>
            ...
            <div class="px-8 py-8">
                ...
                <div class="bg-green-50 border border-green-200 rounded-xl p-6 mb-8 text-center">
                    ...
                    <p class="text-3xl font-bold text-green-700 tracking-wider">{{ $application->application_reference }}</p>
                ...
                <div class="bg-emerald-50 border border-emerald-200 rounded-xl p-6 mb-8">
                    <div class="flex items-center justify-between">
                        <div>
                            <h3 class="text-lg font-semibold text-emerald-900 mb-1">Payment Details Document</h3>
                            <p class="text-sm text-emerald-700">Download your payment instructions as a PDF for your records.</p>
                        </div>
                        <a href="{{ route('portugal-certificate.download-payment-pdf', $application->application_reference) }}"
                           class="inline-flex items-center px-5 py-2.5 bg-emerald-600 text-white font-semibold rounded-lg hover:bg-emerald-700 transition shadow-sm">
                ...
                <div class="bg-amber-50 border border-amber-200 rounded-xl p-6 mb-8">
                    ...
                    <div class="mt-4 text-center">
                        <a href="{{ route('portugal-certificate.receipt.show', $application->application_reference) }}"
                ...
                <div class="border-t border-gray-200 pt-6">
                    ...
                    <ol class="space-y-4">
                        <li class="flex items-start">
                            <span class="flex-shrink-0 w-8 h-8 bg-green-100 text-green-600 rounded-full flex items-center justify-center font-bold text-sm mr-3">1</span>
                            <div>
                        ...
                        <li class="flex items-start">
                            <span class="flex-shrink-0 w-8 h-8 bg-green-100 text-green-600 rounded-full flex items-center justify-center font-bold text-sm mr-3">2</span>
                            <div>
                        ...
                        <li class="flex items-start">
                            <span class="flex-shrink-0 w-8 h-8 bg-green-100 text-green-600 rounded-full flex items-center justify-center font-bold text-sm mr-3">3</span>
                            <div>
                                <p class="font-medium text-gray-900">Application Processing</p>
                                <p class="text-sm text-gray-600">We submit your application to Portuguese authorities</p>
                            </div>
                        </li>
                        <li class="flex items-start">
                            <span class="flex-shrink-0 w-8 h-8 bg-green-100 text-green-600 rounded-full flex items-center justify-center font-bold text-sm mr-3">4</span>
                            <div>
