...
<div class="space-y-6">
    ...
    <div class="bg-blue-50 border border-blue-200 rounded-xl p-6 mt-8">
        ...
        <div class="bg-white rounded-lg p-4 text-sm">
            <p class="mb-2"><strong>Bank:</strong> Millennium BCP</p>
            <p class="mb-2"><strong>IBAN:</strong> PT50 0033 0000 0012345678901</p>
            <p class="mb-2"><strong>BIC/SWIFT:</strong> BCOMPTPL</p>
