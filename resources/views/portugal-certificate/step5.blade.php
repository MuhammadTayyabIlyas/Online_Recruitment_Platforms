    ...
    <div class="grid md:grid-cols-2 gap-4">
        <div>
            ...
            <input type="tel" name="phone_number" id="phone_number"
                   ...
                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 @error('phone_number') border-red-500 @enderror"
