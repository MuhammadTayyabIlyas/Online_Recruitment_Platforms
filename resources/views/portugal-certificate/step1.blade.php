...
<!-- Disclaimer Modal -->
<div x-data="{
    showDisclaimer: {{ session('portugal_disclaimer_accepted') ? 'false' : 'true' }},
    accepted: false
}" x-cloak>
    <!-- Modal Backdrop -->
    <div x-show="showDisclaimer"
        ...
        <div class="flex min-h-screen items-center justify-center p-4">
            ...
            <div x-show="showDisclaimer"
                ...
                <!-- Header -->
                <div class="bg-gradient-to-r from-green-600 to-emerald-700 px-6 py-5 rounded-t-2xl">
                    <div class="flex items-center">
                        ...
                        <h3 class="ml-4 text-xl font-bold text-white" id="disclaimer-title">
                            Criminal Record Certificate Disclaimer
                        </h3>
                    </div>
                </div>
                ...
                <div class="bg-gray-50 px-6 py-4 rounded-b-2xl border-t border-gray-200">
                    <div class="flex flex-col sm:flex-row items-center gap-4">
                        ...
                        <label class="flex items-start cursor-pointer flex-1">
                            <input type="checkbox" x-model="accepted" class="mt-1 h-4 w-4 text-green-600 border-gray-300 rounded focus:ring-green-500">
                        ...
                        <div class="flex gap-3">
                            ...
                            <button type="button"
                                    @click="if(accepted) {
                                        fetch('{{ route('portugal-certificate.accept-disclaimer') }}', {
                                            method: 'POST',
                                            headers: {
                                    ...
                                    :disabled="!accepted"
                                    :class="accepted ? 'bg-green-600 hover:bg-green-700 cursor-pointer' : 'bg-gray-300 cursor-not-allowed'"
            ...
            <div class="mt-4 space-y-3">
                @foreach($existingDrafts as $draft)
                    <div class="flex items-center justify-between bg-white rounded-lg p-4 border border-amber-200 shadow-sm">
                        ...
                        <a href="{{ route('portugal-certificate.resume', $draft->application_reference) }}"
...
<div class="space-y-6">
    ...
    <div class="grid md:grid-cols-3 gap-4">
        <div>
            ...
            <input type="text" name="first_name" id="first_name"
                   ...
                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 @error('first_name') border-red-500 @enderror"
        ...
        <div>
            ...
            <input type="text" name="last_name" id="last_name"
                   ...
                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 @error('last_name') border-red-500 @enderror"
                   placeholder="As per passport" required>
            @error('last_name')
                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
            @enderror
    ...
    <div class="grid md:grid-cols-2 gap-4">
        <div>
            ...
            <input type="text" name="father_name" id="father_name"
                   ...
                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 @error('father_name') border-red-500 @enderror"
        ...
        <div>
            ...
            <input type="text" name="mother_name" id="mother_name"
                   ...
                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 @error('mother_name') border-red-500 @enderror"
                   placeholder="Full name as per official documents" required>
            @error('mother_name')
                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
            @enderror
        ...
        <div class="flex gap-4">
            <label class="inline-flex items-center">
                <input type="radio" name="gender" value="male"
                       ...
                       class="w-4 h-4 text-green-600 border-gray-300 focus:ring-green-500" required>
    ...
    <div>
        ...
        <input type="date" name="date_of_birth" id="date_of_birth"
               value="{{ $dobValue ?? '' }}"
               max="{{ date('Y-m-d') }}"
               class="w-full md:w-1/2 px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 @error('date_of_birth') border-red-500 @enderror"
               required>
        @error('date_of_birth')
            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
        @enderror
    ...
    <div class="grid md:grid-cols-2 gap-4">
        <div>
            ...
            <input type="text" name="place_of_birth_city" id="place_of_birth_city"
                   ...
                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 @error('place_of_birth_city') border-red-500 @enderror"
                   required>
        ...
        <div>
            ...
            <input type="text" name="place_of_birth_country" id="place_of_birth_country"
                   ...
                   class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 @error('place_of_birth_country') border-red-500 @enderror"
                   required>
    ...
    <div>
        ...
        <input type="text" name="nationality" id="nationality"
               ...
               class="w-full md:w-1/2 px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 @error('nationality') border-red-500 @enderror"
               required>
        @error('nationality')
            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
        @enderror
