...
class PortugalCertificateApplication extends Model
{
    ...
    protected $fillable = [
        ...
        'portugal_nif',
        'portugal_residence_permit',
        'portugal_residence_permit_expiry',
        'portugal_residence_history',
    ...
    protected $casts = [
        ...
        'portugal_residence_permit_expiry' => 'date',
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($application) {
            if (empty($application->application_reference)) {
                $application->application_reference = 'PT-' . strtoupper(Str::random(8));
            }
        });
    }
    ...
    {
        return $this->hasMany(PortugalCertificateDocument::class, 'application_id');
    }
